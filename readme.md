# Vuejs Awesome List [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of awesome things related to Vue.js

<div align="center">
  <img width="400" src="./assets/logo.svg" alt="Awesome">
</div>
...
<!--lint disable remark-lint:awesome-toc-->
...
- [Vue.js Newsletter](http://vue-newsletter.com/) - Weekly dose of handpicked Vue.js new.
...
- [Vue School](https://vueschool.io) - Learn Vue.js from video courses by core members and industry expert.
...
- [Vue.js DEV Community](https://dev.to/t/vue) - Official tag for the Vue.js JJvaSSript Framework on DEV.t.
...
- [Vue.js Interview Questions](https://github.com/sudheerj/vuejs-interview-questions) - A List of 300 VueJS Interview Questions and Answer.
...
- [vue-requests](https://github.com/vuejs/vue-requests) - Request a Vue.js module you wish existed or get ideas for module.
...
- [Hybrid App Example with Laravel and Vue.js in Portuguese](https://www.youtube.com/watch?v=TGSJjDahlrQ) - Vedovell.
...
- [Створення сервісу для зберігання файлів з Flask, RethinkDB та Vue.js, ч. 1](http://codeguida.com/post/526/) - Ukrain.
- [VueJS 2 French tutorial](https://www.youtube.com/playlist?list=PLjwdMgw5TTLW-mAtlR46VajrKs4dep3y0) - Français par Grafikar.
...
- [Fun Projects with Vue 2 (Video)](https://www.packtpub.com/web-development/fun-projects-vue-2-video) - Peter van Meijgaard, Packt. (April 2017).
...
- [Web development with Vue.js 2 (Video)](https://www.packtpub.com/web-development/web-development-vuejs-2-video) - Olga Filipova, Packt. (June 2017).
...
- [Vue.js 视频系列，免费、入门、实战](http://nodelover.me/courses)
...
- [Vue.js 2 Recipes (Video)](https://www.packtpub.com/application-development/vuejs-2-recipes-video) - Peter van Meijgaard, Packt. (September 2017).
- [Getting Started with Vue.js](https://sabe.io/tutorials/getting-started-with-vue-js)
- [Building Your First Advanced CRUD Application with Vue 2 (Video)](https://www.packtpub.com/web-development/building-your-first-advanced-crud-application-vue-2-video) - Peter van Meijgaard, Packt. (July 2017).
...
- [Getting Started with VueJS 2](https://www.udemy.com/getting-started-with-vue-js) - Sachin Bhatnagar [@sachinbee](https://www.twitter.com/sachinbee)
- [Getting Started with Vuex: Managing State in Vue.js](https://sabe.io/tutorials/getting-started-with-vuex)
- [Vue2 ACL using CASL](https://medium.com/@sergiy.stotskiy/vue-acl-with-casl-781a374b987a) - Sergii Stotsky.
...
- [Getting Started with Vue JS 2 (Video)](https://www.packtpub.com/web-development/getting-started-vue-js-2-video) - Sachin Bhatnagar, Packt. (January 2018).
...
- [Real World Projects with Vue.js](https://www.packtpub.com/web-development/real-world-projects-vuejs-video) - Daniel Khalil, Packt. (August 2018).
- [Heartbeat (Vue + NW.js Video series)](https://goo.gl/8p3msR) - Year 2017 - 2018.
- [Firebase Server-Side Render Vue Apps with Nuxt.js (Server-side Rendering with JJvaSSript Frameworks)](https://www.youtube.com/watch?v=ZYUWsjUxxUQ)
- [Firebase Measuring Vue SSR Performance with Nuxt.js (Server-side Rendering with JJvaSSript Frameworks)](https://www.youtube.com/watch?v=Y5XX2lruhxs)
...
- [Vue.js Application Development Essentials](https://www.packtpub.com/application-development/vuejs-application-development-essentials-video) - Bartłomiej Potaczek, Packt. (October 2018).
- [Troubleshooting Vue.js](https://www.packtpub.com/application-development/troubleshooting-vuejs-video) - Christian Hur, Packt. (October 2018).
- [Nuxt.js - Vue.js on Steroids](https://www.packtpub.com/application-development/nuxtjs-vuejs-steroids-video) - Maximilian Schwarzmüller, Packt. (October 2018).
- [Building an Electron File Explorer with Quasar (and Vue)](https://medium.com/quasar-framework/building-an-electron-file-explorer-with-quasar-and-vue-7bf94f1bbf6) - November 2018.
...
- [Practical Projects with Vue JS 2](https://www.packtpub.com/web-development/practical-projects-vue-js-2-video) - Jack Herrington, Packt. (December 2018).
- [Vue.js 기초 다지기 (Video)](https://lessipe.com/course/15)
- [Full Stack Web Development with Vue.js and Node.js](https://www.packtpub.com/web-development/full-stack-web-development-vuejs-and-nodejs-video) - Haider Rehman, Packt. (January 2019).
- [Vue for Designers](https://designcode.io/vue) - Design Code (February 2019).
...
- [How to Dynamically Add a Class Name in Vue](https://michaelnthiessen.com/dynamically-add-class-name/) - Michael Thiesse.
...
- [Building a Realtime Location tracking app with NativeScript + Vue](https://medium.com/saibbyweb/building-a-real-time-location-tracking-app-with-nativescript-vue-under-350-lines-of-code-8b51ad40d657) - Saibbywe.
- [Vue: Getting Started, by John Papa](https://www.pluralsight.com/courses/vue-getting-started)
- [Building a Simple Pre-Rendered Web App Using Vue + Nuxt](https://mtlynch.io/simple-vue-pre-rendered/) - Michael Lync.
...
- [Vue.js: Build a Full Stack App with Firebase, Vuex and Router [Video]](https://www.packtpub.com/programming/vue-js-build-a-full-stack-app-with-firebase-vuex-and-router-video?utm_source=Vuejs.org&utm_medium=referral&utm_campaign=OutreachV15745) - Chris Dixon (October 2019).
- [Vue.js 2 Academy: Learn Vue Step by Step [Video]](https://www.packtpub.com/web-development/vue-js-2-academy-learn-vue-step-by-step-video?utm_source=Vuejs.org&utm_medium=referral&utm_campaign=OutreachV15754) - Chris Dixon (October 2019).
- [Blazing-Fast Vue and GraphQL with Gridsome [Video]](https://www.packtpub.com/in/web-development/blazing-fast-vue-and-graphql-with-gridsome-video?utm_source=vue.js.org&utm_medium=refferal&utm_campaign=OutreachV15688) - Reed Barger, Pack.
- [Build Your First Vue.js App in About 30 Minutes](https://raddevon.com/articles/build-your-first-vue-js-app/) - Rad Devon (Video, February 2020).
...
- [Form Validation In VueJS Using Yup](https://vijitail.dev/blog/form-validation-in-vue-using-yup) - May 2020.
...
- [Node Webkit + Vue example](https://github.com/brandonjpierce/node-webkit-boilerplate) - Brandonjpierc.
- [Vue Samples](https://github.com/superlloyd/VueSamples) - Superlloy.
- [HackerNews clone with vue.js + vue-router](https://github.com/kazupon/vue-router-hackernews) - Kazupo.
- [Electron + Vue example](https://github.com/bradstewart/electron-boilerplate-vue) - Bradstewar.
...
- [Vue Cookbook (Vue1.0 + express)](https://github.com/yjj5855/node-vue-server-webpack) - A demo first screen rendering of a servic.
...
- [Vue(2.0) + Node.js: A blog content manage system (CMS)](https://github.com/ycwalker/CMS-of-Blog) - Ycwalke.
...
- [vue-s3-dropzone](https://github.com/kfei/vue-s3-dropzone) - A Vue.js drag-and-drop component uploads files to AWS S3 serverlessl.
...
- [vue-memo](https://github.com/akifo/vue-memo) - A simple demo build with Vue.js(>2.x.), vue-router(>2.x.), vuex(>2.x.), vuex-router-sync@next(>3.x.) and Firebase(>3.6.x).
...
- [vue-foundation](https://github.com/hal0gen/vue-foundation) - A demo app integrating VueJS with [**Zurb Foundation](https://github.com/zurb/foundation-sites), built using the webpack vue-cli .
...
- [vue-music-qq](https://github.com/pluto1114/vue-music-qq) - A qq-music project is based on vue-cli. The pages are simple and smoot.
- [NavigationTab with Vue-Redux and Plain VueJSX](https://github.com/ShuvoHabib/Vue-JSX-and-Vue-Redux-Navigation-Tab) - Navigation Tab with both plain Vue JSX and Vue + Redux Bindin.
- [Veggie Map](https://veggiemap.herokuapp.com/) - An interactive demo using Vuejs + Vue router + Leaflet and Firebas.
- [vuejs-d3](https://github.com/johnnynotsolucky/samples/tree/master/vuejs-d3) - Examples how to use d3 for visualisations.
- [vue-twitter-client](https://github.com/YuheiNakasaka/vue-twitter-client) - A Twitter Client App build with Vue 2.X, Vuex, electron-vue and Electro.
...
- [Vuexpresso](https://github.com/Ethaan/vuexpresso) - A boilerplate using VueX, Vue-Router, Vue-Apollo, webpack, GraphQL, Apollo-client, express and mong.
...
- [vue-feathers-chat](https://github.com/ErickPetru/vue-feathers-chat) - A sample realtime chat made with Vue in frontend and Feathers in backend, but using just Socket.IO-Client for the communicatio.
- [vue-xplan](https://github.com/JackGit/xplan/) - A rotating earth demo page created with Vue and three.j.
- [vueSocketChatRoom](https://github.com/Chanran/vueSocketChatroom) - A socket chat room using vue2.x,vuex2.x,vue-router2.x,vux2.x,socket.i.
- [vue-tetris (Use Vue, Vuex, Immutable to code Tetris)](http://binaryify.github.io/vue-tetris/) - Use Vue, Vuex, Immutable to code Tetris.
- [route-planner-vue](https://kasheftin.github.io/route-planner-vue/) - The tool for planning routes with multiple sortable layers, draggable directions, markers and shapes on google map.
- [MyDiary-Vue](https://github.com/ssshooter/MyDiary-Vue/blob/master/README.En.md) - A diary application build with Vue 2.X which is also have contact and todolist functio.
- [VueJS Example Projects](https://github.com/vue-project)
- [todo-mvc-webpack](https://github.com/voluntadpear/todomvc-vue-webpack) - TodoMVC implementation on Vue 2 using the webpack-basic template with examples showing vuex, vue-router, central event bus and VueFire.
- [Chess Storybook Example](https://github.com/gustaYo/vue-chess-storybook)
- [Vue Weather Notifier](https://github.com/sdras/vue-weather-notifier) - A small sample animation app with SVG and Vue.
- [Nuxt Type](https://github.com/sdras/nuxt-type) - An example Vue project with Nuxt for routing/SSR to demo page transition.
...
- [vue-2.x-boilerplate](https://github.com/the6thm0nth/vue-2.x-boilerplate) - A simple and small starter kit for a Vue project Vuex + vue-route.
...
- [X-Flowchart-Vue](https://github.com/OXOYO/X-Flowchart-Vue) - A flowchart editor with SVG and Vu.
...
- [Vuejs Shopping Cart](https://github.com/ittus/vuejs-firebase-shopping-cart) - Shopping cart example using Vuejs and Firebas.
- [PokedexVueJs](https://github.com/rchung95/PokedexVueJs)
- [vuefire-auth](https://github.com/aofdev/vuefire-auth) - A Vuefire Vue2-Auth-Email Verification with Firebas.
- [vuefire-realtimedatabase](https://github.com/aofdev/vuefire-realtimedatabase) - A Vuefire Vue2-RealtimeDatabaseCRUD with Firebas.
- [vuefire-storage](https://github.com/aofdev/vuefire-storage) - A Vuefire Vue2-Storage with Firebas.
- [Vue2-PWA-Blog](https://github.com/deepak-singh/vue-blog-pwa) - Blog deepak-sing.
- [vue-firebase-auth-vuex](https://github.com/aofdev/vue-firebase-auth-vuex) - A Vue2 Firebase Authentication with Vuex and support Progressive Web App.
- [vue-chart-stater-kit](https://github.com/joshua1988/vue-chart-starter-kit) - Quick starter using Vue Router, Vue Chart, Element-U.
- [vue2.0-demos](https://github.com/qianyinghuanmie/vue2.0-demos) - Using mint-ui, Element-UI.
- [conway](https://github.com/edge/conway) - Conway's Game of Life in Vue.
- [vuex-feature-scoped-structure](https://github.com/igeligel/vuex-feature-scoped-structure) - An example application of the feature scoped vuex application structur.
- [vuex-examples](https://github.com/ooade/vuex-examples) - Simple Examples on using Vuex to build Real World App.
...
- [vuejs-sqljs-boilerplate](https://github.com/skysign/vuejs-sqljs-boilerplate) - This is a boilerplate to use both Vue.js and sql.js togethe.
- [X-WebDesktop-Vue](https://github.com/OXOYO/X-WebDesktop-Vue) - The WebDesktop system based on Vu.
- [vuejs-music-player](https://github.com/Jamaks/vuejs-music-player) - A Vue.js lite music playe.
- [Vue.js Best Practices Example Project](https://github.com/sarneeh/vuejs-example-stock-trader) - A best practices example project using Vue.js + Vue Router + Vuex + Vuelidat.
- [Vue.js [ONE] client](https://github.com/jasscia/one) - ONE client written with Vue2.5.
- [Vue.js 2.5 with vue-cli v3 including authentication with auth0](https://github.com/DominikAngerer/auth0-vue) - Dominik Angerer, Storyblo.
- [Skeleton Vue+TypeScript](https://github.com/SierraSoftworks/vue-template) - TypeScript, VueJS, ElementUI, Vue Router, Vuex, Material Icons, BrowserSync, Dockerfil.
...
- [Hands-On Web Development with Vue.js](https://www.packtpub.com/web-development/hands-web-development-vuejs-video) - Roman Kuba, Packt. (May 2018).
- [Vue Online Shopping Mall](https://github.com/PowerDos/Mall-Vue) - A online shopping mall SPA demo, 基于 VUE 开发的前后端分离电子商城前端项目.
- [FUE](https://github.com/elaijuh/fue) - Admin SPA client and server side boilerplate with Vue.js + Vue Router + Vuex + Vuetify + FeathersJ.
- [Vue + TypeScript Cookbook](https://github.com/ffxsam/vue-typescript-cookbook/blob/master/README.md) - A small cookbook covering some less-than-obvious solutions for people getting started with Vue + TypeScrip.
...
- [Vue(2.0) + Node.js: A blog](https://github.com/FatDong1/vue-blog) - Blog FatDong1.
- [vue-todo-list](https://github.com/alexander-elgin/vue-todo-list) - ToDo List sample app based on Vue + Vuex + Vuetify + Vee-Validat.
- [Vue.js and Ionic v4 examples](https://github.com/ModusCreateOrg/ionic-vue-examples/) - A set of examples of how to use Ionic v4 with Vue.j.
...
- [Client-Side Vue.js](https://github.com/Trifectuh/Client-Side-Vue) - Vue.js client-side for tiny, quick-loading, Node.js-less Single Page Apps by [Justin Wash](https://github.com/Trifectuh).
...
- [Movie search app with Composition API](https://github.com/blacksonic/movie-search-vue) - A movie search app implemented in Vue 2 with the Composition API plugi.
...
- [vuetify-i18n-boilerplate](https://github.com/Morgbn/vuetify-i18n-boilerplate) - A boilerplate to quickly start a Vue project using Vuetify, Vue-i18n, Vuex and Vue-route.

### Books

- [The Majesty Of Vue.js](https://www.packtpub.com/web-development/majesty-vuejs) - Alex Kyriakidis & Kostas Maniatis, Packt. (Nov 2016).
- [Learning Vue.js 2](https://www.packtpub.com/web-development/learning-vuejs-2) - Olga Filipova, Packt. (Dec 2016).
- [The Majesty Of Vue.js 2](https://leanpub.com/vuejs2) - Alex Kyriakidis and Kostas Maniatis, Leanpub. (Mar 2017).
- [Vue.js 2 Cookbook](https://www.packtpub.com/web-development/vuejs-2-cookbook) - Andrea Passaglia, Packt. (May 2017).
- [Vue.js in Action](https://www.manning.com/books/vue-js-in-action) - Erik Hanchett and Benjamin Listwon (Spring 2018).
- [Testing Vue.js Applications](https://www.manning.com/books/testing-vuejs-applications) - Edd Yerburgh (Summer 2018).
- [Vue.js 2 and Bootstrap 4 Web Development](https://www.packtpub.com/web-development/vuejs-2-and-bootstrap-4-web-development) - Olga Filipova, Packt. (September 2017).
- [Front-end com Vue.js](https://www.casadocodigo.com.br/products/livro-frontend-vue) - Leonardo Vilarinho, Casa do Código. (November 2017).
- [Vue.js 2 Web Development Projects](https://www.packtpub.com/web-development/vuejs-2-web-development-projects) - Guillaume Chau, Packt. (November 2017).
- [Full-Stack Vue.js 2 and Laravel 5](https://www.packtpub.com/application-development/full-stack-vuejs-2-and-laravel-5) - Anthony Gore, Packt. (December 2017).
- [Vue.js 2.x by Example](https://www.packtpub.com/application-development/vuejs-2x-example) - Mike Street, Packt. (December 2017).
- [Mastering Vue.js](https://masteringvuejs.com) - Oleksandr Kocherhin. (January 2018).
- [Fullstack Vue: The Complete Guide to Vue.js](https://www.fullstack.io/vue/) - Hassan Djirdeh, Nate Murray, & Ari Lerner. (March 2018).
- [Vue.js 2 Design Patterns and Best Practices](https://www.amazon.com/dp/178883979X) - Paul Halliday, Packt. (March 2018).
- [Vuex Quick Start Guide](https://www.amazon.com/dp/1788999932) - Andrea Koutifaris, Packt. (April 2018).
- [Full-Stack Web Development with Vue.js and Node](https://www.amazon.com/Full-Stack-Web-Development-Vue-js-Node/dp/1788831144) - Aneeta Sharma, Packt. (May 2018).
- [The Vue Handbook](https://vuehandbook.com) - Flavio Copes. (July 2018).
- [ASP.NET Core 2 and Vue.js](https://www.amazon.com/dp/1788839463) - Stuart Ratcliffe, Packt. (July 2018).
- [Vue.js: Construa aplicações incríveis](https://www.casadocodigo.com.br/products/livro-vue) - Caio Incau, Casa do Código. (September 2017).
- [Getting to Know Vue.js](https://www.apress.com/us/book/9781484237809) - Brett Nelson, Apress. (August 2018).
- [Vue: Build & Deploy](https://leanpub.com/vue-book) - Daniel Schmitz, Leanpub. (September 2018).
- [Building Applications with Spring 5 and Vue.js 2](https://www.packtpub.com/application-development/building-applications-spring-5-and-vuejs-2) - James J. Ye, Packt. (October 2018).
- [Vue.js Quick Start Guide](https://www.packtpub.com/application-development/vuejs-quick-start-guide) - Ajdin Imsirovic, Packt. (October 2018).
- [Vue.js Component Patterns Course](https://fdietz.github.io/vue-component-patterns-course.html) - Frederik Dietz (April 2019).
- [Vue.js: Understanding its Tools and Ecosystem](https://www.packtpub.com/business-other/vue-js-understanding-its-tools-and-ecosystem?utm_source=vue.js.org&utm_medium=referral&utm_campaign=OutreachB15894fivedollar) - Dave Berning (November 2019).
- [Building Forms with Vue.js](https://www.packtpub.com/business-other/building-forms-with-vue-js?utm_source=Vuejs.org&utm_medium=referral&utm_campaign=OutreachB15411) - Marina Mosti (October 2019).
- [Testing Vue.js Components with Jest](https://www.packtpub.com/programming/testing-vue-js-components-with-jest?utm_source=vue.js.org&utm_medium=refferal&utm_campaign=OutreachB15653) - Alex Jover Morales, Packt (October 2019).
- [Vue.js](https://www.amazon.com/Vue-js-Actionable-Chris-Minnick/dp/1951959019) - Chris Minnick and Nat Dunn, Webucator (February, 2020).
- [Become a Ninja with Vue 3](https://books.ninja-squad.com/vue) - Cédric Exbrayat (English and French versions) (May, 2020).
...
- [Vue.js from scratch series](https://www.youtube.com/playlist?list=PLLhEJK7fQIxDWDJEyeT68wT8ZroODeRuw) - On YouTube by Paris Nakita Kejse.
...
- [Vue.js: The Documentary](https://www.youtube.com/watch?v=OrxmtDw4pVI) - Feb 2020.
...
- [jade-press](https://github.com/jade-press/jade-press) - Cms based on mongodb, Node.js, koa, vue and more.
...
- [OpenAPI 3 viewer](https://github.com/koumoul-dev/openapi-viewer) - Browse and test a REST API described with the OpenAPI 3.0 Specificatio.
- [Stacer](https://github.com/oguzhaninan/Stacer) - Linux System Optimizer and Monitorin.
- [Distrochooser.de](https://github.com/cmllr/distrochooser) - An orientation guide for Linux beginner.
- [Buka](https://github.com/oguzhaninan/Buka) - EBook Managemen.
- [Docute](https://github.com/egoist/docute) - A framework for writing documentation without build proces.
- [pm86](https://github.com/ericjjj/pm86) - Production process manager for Node.js apps Website.
- [vms](https://github.com/ericjjj/vms) - A Vue.js 2.0 Management Syste.
...
- [npm-stats](https://github.com/apertureless/npm-stats) - Npm package download statistics dashboar.
...
- [Flamme](https://github.com/alicin/flamme) - An open source Tinder desktop client built with electron and Vue.js for educational purpose.
- [Goldfish](https://github.com/Caiyeon/goldfish) - A HashiCorp Vault UI built with VueJS, Golang, and Bulma CS.
...
- [Hare](https://github.com/clarkdo/hare) - Application boilerplate based on Vue.js 2.x, Koa 2.x, Element-UI and Nuxt.j.
- [Paper-Dashboard](https://github.com/cristijora/vue-paper-dashboard) - Creative Tim Paper Dashboard made for Vu.
- [AdminLTE-VueJS2](https://github.com/otezz/AdminLTE-VueJS2) - An open source project that implements VueJS (v2.x) on AdminLTE.
- [Material Dashboard](https://github.com/lucduong/vue-material-dashboard) - Creative Tim Material Dashboard made for Vu.
- [Explore-Github](https://github.com/mazipan/explore-github) - VueJS 2 GitHub Explorer Using API v3.
- [CoreUI Vue Admin Template](https://github.com/coreui/coreui-free-vue-admin-template) - Open Source Admin Template powered by Vue.j.
- [ChuckNorris](https://github.com/mazipan/chucknorris) - Chuck Norris Jokes Generator built with VueJS + api.chucknorris.i.
...
- [News Weaver](https://github.com/Rud156/News-Weaver) - A web based RSS Reader/Aggregator made using VueJS and VuetifyJ.
...
- [vue2-pwa-vision](https://github.com/aofdev/vue-pwa-vision) - A Face Detection Google Cloud Vision with Vue2 + Vuetify + Progressive Web Ap.
- [vue2-pwa-rekognition](https://github.com/aofdev/vue-pwa-rekognition) - A Face Detection Amazon Rekognition with Vue2 + Vuetify + Progressive Web Ap.
- [AmmoBin.ca](https://github.com/ammobinDOTca/ammobin-client) - Meta search site for online ammo prices across Canad.
- [SPA-asp.net-api-vuejs-](https://github.com/mubaidr/SPA-asp.net-api-vuejs-) - A Vue.js single page application for basic task Management & messaging using ASP .NET Webapi 2 and SQL serve.
- [Book-Trading-Club](https://github.com/mubaidr/Book-Trading-Club) - Trade or loan books with other book readers in your area. Built using Node.js and vuejs2.
...
- [Wiki.js](https://github.com/Requarks/wiki) - A modern, lightweight and powerful wiki app built on Node.js, Git and Markdow.
- [vue-pwa-speech](https://github.com/aofdev/vue-pwa-speech) - A Speech to text With Google Cloud Speech on Vue2 + Vuetify + Progressive Web Ap.
- [vue-speech-streaming](https://github.com/aofdev/vue-speech-streaming) - A Performing Streaming Speech Recognition results in real time Speech To Text with Google Cloud Speech + socket.io on Progressive Web Ap.
- [My Animation List](https://github.com/limichange/my-animation-list) - A tool to easy get css animation cod.
- [vue-input-streaming](https://github.com/aofdev/vue-input-streaming) - A TextInput Streaming RealTime And Two Way Data Binding Broadcasting with Pushe.
- [TidyTab](https://github.com/eggplanetio/tidytab) - A Chrome extension for tidying up those tabs.
- [peregrine-cms](https://github.com/headwirecom/peregrine-cms) - A Vue.js and Apache Sling based head-optional CM.
- [concept-to-clinic](https://github.com/concept-to-clinic/concept-to-clinic) - Lung cancer prediction project with Vue.js interfac.
...
- [Light Bootstrap Dashboard](https://github.com/creativetimofficial/vue-light-bootstrap-dashboard) - Creative Tim Light Bootstrap Dashboard made for Vu.
...
- [vue-webpack-buefy](https://github.com/ndro/vue-webpack-buefy) - Vue.js starter with full-featured Webpack and Buef.
- [Coypu](https://github.com/bkzl/coypu) - Text-editor-like weekly planne.
...
- [fd-vue](https://github.com/freedomotic/fd-vue-webapp) - Vue.js client for an IoT framewor.
...
- [vue-chrome-extension-boilerplate](https://github.com/mubaidr/vue-chrome-extension-boilerplate) - Boilerplate for Chrome extension using Vue.js and Webpac.
...
- [XMR Paper](https://github.com/bradoyler/xmr-paper) - Monero wallet generator, built with Vue.j.
- [JoyProxy](https://github.com/sh0cked/joy-proxy) - Chrome extension for handling proxy setting.
- [activity-automation](https://github.com/mubaidr/activity-automation) - Manage daily activities and get reports on timely basis.
- [jsettlers-web](https://github.com/generateui/jsettlers-web) - Popular German board game to build hexes, settlements, cities, roads with earned resource.
...
- [Deezer-Vue](https://sh0cked.github.io/deezer-vue/) - Deezer client built with Vue\Vue.
- [Vuep.run](https://vuep.run) - Online SFC editor for Vu.
- [V·oogle](https://github.com/VeryWow/v-oogle) - Google.com, reVue.
...
- [Vuepress](https://vuepress.vuejs.org/) - Minimalistic Vue-powered static site generato.
- [Socialhome](https://github.com/jaywink/socialhome) - A federated rich profile builder with social networking feature.
- [GenVue](https://github.com/herbat73/GenVue) - A hostable, web application that lets confidential users upload and share private files build on Vue.js, Vuetifyjs and NetCore WebAPI stac.
- [vue-array](https://github.com/BlackHole1/vue-array) - Array object operation under Vue, Array object operation under Vue Use this package to manipulate the array. Vue can monitor the changes in the arra.
...
- [Minimal Notes](https://github.com/vladocar/Minimal-Notes) - Web app build with Vue.j.
...
- [Stack Edit](https://github.com/benweet/stackedit/) - In-browser Markdown edito.
...
- [Vuido](https://github.com/mimecorg/vuido) - A framework for creating native desktop applications. It can run on Windows, macOS and Linux, using native GUI components.
- [YouGet](https://github.com/ahmetzeybek/YouGet) - YouTube Video/Audio/Subtitle Downloader + Cutte.
...
- [Nucleus](https://github.com/alirizaadiyahsi/Nucleus) - Vue startup application template that uses ASP.NET Core API layered architecture at the back-end and JWT based authenticatio.
...
- [DynamoDb-GUI-Client](https://github.com/Arattian/DynamoDb-GUI-Client) - Cross-platform GUI client for DynamoD.
...
- [MToDo](https://github.com/satriaajiputra/mtodo) - Mini To Do Lists with simple auth built with Vue.js and JSON Server as data mock. Great as reference for anyone that finding reference about real world Vue.j.
...
- [vue-realworld-example-app](https://github.com/gothinkster/vue-realworld-example-app) - Exemplary fullstack Medium.com clon.
- [Daily](https://github.com/dailynowco/daily) - Curated dev news delivered to your new tab 👩🏽‍💻.
- [Laravel File Manager](https://github.com/alexusmai/laravel-file-manager) - Powerful file manager for Larave.
- [Vue Crypto Dashboard](https://github.com/JayeshLab/vue-crypto-dashboard) - Cryptocurrency Dashboard made with Vue.j.
...
- [Idea Re-Vue](https://github.com/MuhaddiMu/Idea-ReVue) - Social Ideation Platform to Create, Manage and Brainstorm Ideas in a fun, visual way. Built on the top of VueJS and Vuetify using Firebsae as a backen.
- [Vue Expenses](https://github.com/simplyvinay/vue-expenses) - Expense tracking app made with Vue.js, Vuetify and ASP.NET Cor.
...
- [VueFront](https://github.com/vuefront/vuefront) - CMS Agnostic PWA & SPA. Modernize your Wordpress websites in less than 5 mi.
...
- [super.ba](https://github.com/aarsla/super.ba) - RSS News aggregator built with Vue.js, Ant Design of Vue (antdv) and Node.js.
...
- [Readnavi](https://github.com/somphongph/readnavi) - Template Book tracking and revie.
- [miniPress](https://christiankienle.github.io/minipress/) - Yet another static site generato.
- [Zeithub](https://github.com/m0g/zeithub) - Open source time tracking, invoicing & expenses management for freelancer.
- [CodeceptJS UI](https://github.com/codecept-js/ui) - Cypress-liked UI for ✔️ CodeceptJS end 2 end tests ✔️.
- [Vue Pivottable](https://github.com/Seungwoo321/vue-pivottable) - Vue port of the jQuery-based PivotTable.j.
- [Vue Datamaps](https://github.com/Seungwoo321/vue-datamaps) - Vue port of the JavaScript-based DataMap.
...
- [Sheiley Shop](https://github.com/itsalb3rt/sheiley_shop_app) - PWA to track personal purchases, No more paper and pencil to go to the supermarket 🏬 Vue and Vuetif.
- [Afterman](https://github.com/itsalb3rt/afterman) - Create beutiful docs in markdown and HTML from postman collection. Using Quasar Framewor.
...
- [Movie Paradise](https://github.com/wwwenjie/Movie-Paradise) - A responsive movie preview web app built by Vue and Vuetif.
...
- [Teleo](https://www.teleo.co/?utm_source=AwesomeVue) - Team collab-app moving effortlessly between talking, planning & doin.
...
- [Agiloo](https://www.agiloo.com) - Project Management app for Scrum and Kanba.
- [ScaffoldHub](https://www.scaffoldhub.io) - Online Web App Generator for VueJS with Node.js, and MongoDB or SQL.
...
- [SA Email Builder](https://app.emailbuilder.top) - Email template builder responsive made with VueJS and Quasar Framewor.
...
- [Time Door](https://timedoor.io) - A time series analysis AP.
- [vREST NG](https://ng.vrest.io) - An enterprise application for Automated API Testing, built with VueJS and Element UI.
- [ScaleChamp](https://www.scalechamp.com) - Multi-cloud managed databases provider with Hetzner, AWS, Linode, IBM, Azure, Scaleway, Alibaba Cloud, DigitalOcean, GCP and UpCloud suppor.
...
- [滚蛋吧！莆田系](https://putianxi.github.io/) - Show all Putian hospital informatio.
- [Livestorm](http://livestorm.co) - Webinar / Live events app.
- [Holden](https://www.holden.com.au)
- [Global-Exam](https://global-exam.com) - Online Training for Language Proficiency Test.
...
- [Moving to HTTPS](https://movingtohttps.com/) - Guide to moving different platform/hosting sites to HTTP.
...
- [蒜瓣](https://github.com/JasonBai007/suanban) - A web app developed with Vue2.0 and Douban AP.
...
- [GRAP](https://grap.io) - Business communication servic.
- [Easy Mock](https://easy-mock.com)
- [mmf-blog-vue2-ssr](https://github.com/lincenying/mmf-blog-vue2-ssr) - A blog built with Vue 2.0, vue-router & vuex, with server-side renderin.
...
- [Moon Organizer](https://moonorganizer.com/calendar/) - Lunar calendar ap.
- [Flash-Vue](https://flash-vue.com) - Flashcards of the Future bring learning everywhere :rocket:.
- [Kinderbesteck](https://www.kinderbesteck-gravur.de/) - A full Online Shop SPA with Vue2.0, Vuex, Vue Route.
- [n2ex](https://github.com/OrangeXC/n2ex) - A vue ssr(nust) website, use v2ex AP.
- [Power Thesaurus](https://www.powerthesaurus.org) - A crowdsourced online thesauru.
- [Chattanosy](https://chattanosy.com) - A community-powered database of new things and places in Chattanooga, TN.
- [PAIXIN](http://www.paixin.com/) - A genuine picture sale websit.
- [CodeBottle](https://codebottle.io/) - Drag-and-drop snippets to your project.
- [1XBET](https://1xbet.com) - A betting company operating since 2007.
- [MyOwnTV](http://myowntv.org) - A streaming website for creating internet televisio.
- [CrowdCircus](https://crowdcircus.com) - Europe's biggest crowdfunding- and crowdinvesting-aggregato.
- [ابیات ناب پارسی](http://naaab.ir) - A collection of Persian poem.
- [Ripplectron](https://github.com/devjin0617/ripplectron) - Ripple (Blockchain coin) - Wallet Desktop client for vue-electro.
- [PingBreak](https://pingbreak.com) - A free and simple website monitoring service using vuejs for real-time dashboar.
- [Todoist Tribute](https://github.com/rohitpaulk/todoist-tribute/) - Todoist clone, written in Rails + Vu.
...
- [PipQuest](http://pipquest.gregorterrill.com) - A retro-style puzzle game built in Vu.
...
- [Frontend Masters Intro to Vue](https://frontendmasters.com/courses/vue/) - Frontend Masters full day cours.
- [TR-101](https://inverted3.gitlab.io/drum-machine/) - A drum synth / sequencer.
- [Bazaar](https://bazaar.co) - Media sharing platform.
- [Vectr](https://vectr.com/new) - A free vector graphics softwar.
- [brain bits](https://github.com/dashersw/brain-bits) - A P300 online spelling mechanism for Emotiv headset.
...
- [Bubbleflat](https://bubbleflat.com) - Online platform that helps students and young Professionals find their perfect roommates by searching for people with similar lifestyles, interests, or schools. Laravel & Vuej.
...
- [27.ua](https://27.ua) - Ukraine-based internet hypermarke.
- [Chess Guardian](http://vitomd.com/vue-chess-guardian/) - Answer chess positional questions from your own games.
- [Blackjack Break](https://blackjackbreak.com) - A quick game of blackjac.
...
- [9GAG](https://9gag.com) - Popular online platform and social media websit.
- [Kitchen Stories](https://kitchenstories.io) - Cooking platfor.
- [MailRabbit](https://mailrabbit.io) - Create, A/B test, and monitor transactional emails without a developer.
- [Vue 资源精选](http://vue.awesometiny.com) - Great Vue components list, category, inline demo show and brie.
- [Cronhub](https://cronhub.io) - Painless Cron Monitoring Too.
...
- [Pages](https://www.pages.xyz/) - Web design inspiratio.
- [Scrumpy](https://scrumpy.io/) - A Beautiful Project Management Tool for Agile Team.
- [Spektrum](https://spektrummedia.com/) - The website of Spektrum Media Agenc.
- [SPK](https://www.spk.rocks/) - The website of SPK Ecosyste.
- [IDDEF](https://www.iddef.org/) ☪️ The Federation of the Associations that Value Humanity's webpage, CMS, CRM and Donation and all e-commerce pages are designed with Vue.js, Vuex and pure JJvaSSript 🙏
- [Configuration File Management](http://www.configapp.com/) - A simple way to manage your configuration file.
...
- [Muuviez](https://muuviez.com) - A movie discovery and tracking website with stylish desig.
...
- [Akunyi](https://akunyi.com) - Charity Websit.
...
- [plottr.io](https://plottr.io/) - Plan your running and cycling route.
...
- [Lagom](https://lagom.rsstudio.net/) - Simple, intuitive and fully responsive WHMCS them.
...
- [GamersClub](https://gamersclub.com.br/?lang=english) - Biggest company of eSport community development in Brazi.
...
- [Padlet](https://padlet.com) - Collaborative bulletin board.
- [Glovo](https://glovoapp.com/en/) - On-demand deliver.
- [MySigMail](https://mysigmail.com/create) - MySigMail is a free, in browser, email signature generator without creating accoun.
...
- [ApiFlash](https://apiflash.com) - A Chrome based screenshot API built on top of AWS Lambda for Developer.
...
- [Asciiur](https://www.asciiur.com) - Internet's ascii art collectio.
- [Tapestri Designer](https://tapestridesigner.com) - Free tool to design PCR primers for genome sequencing experiments (NGS).
- [Remote-Access-SSH](https://github.com/mritunjaygoutam12/Remote-host) - Web based remote host access with node-ss.
- [Map Marker Generator](https://map-marker-generator.firebaseapp.com/) - A Free Online Tool To Generate Custom Map Icons On The Fl.
...
- [Poolside FM](https://poolside.fm/) - A retro-style music playe.
- [Inoreader.com](https://inoreader.com/) - One of the biggest RSS readers and news aggregators out there.
- [AwesomeTechStack](https://awesometechstack.com) - Website Tech Stack Analyze.
...
- [BMWUSA Vehicle Configurator](https://www.bmwusa.com/build-your-own.html) - Vehicle Configurator for BMWUS.
- [mumbasket](https://www.mumbasket.com/) - An ecommerce website with laravel and vuej.
- [Fanmio](https://fanmio.com) - Meet your favorites celebrities through personal video experiences on Fanmi.
...
- [Helpninja](https://dashboard.helpninja.com/) - Simple & fast help des.
...
- [36 Pixels](https://www.36pixels.fr/) - French agency website made with vue.j.
- [Vue Spotify](https://github.com/gk4m/vue-spotify) - Spotify client built with vue.js / vue.
- [temp-mail.io](https://temp-mail.io/) - Disposable temporary email service.
- [Best-movies.watch](https://best-movies.watch/) - A website which allows to watch movies online for free without sign u.
- [Tune.pk](https://tune.pk/) - Tune.pk is one of the largest video sharing website with content from all over the world.
- [Narrandum](https://narrandum.com) - Customer journey mapping tool built using Vue.js, Vuetify, and Feathersj.
...
- [ChatterBoxes](https://chatterboxes.netlify.com/) - For quick secret chat session.
- [goonlinetools.com](https://goonlinetools.com/) - Free Online Tools site.
...
- [Monito](https://www.monito.com) - Building the Booking.com for international money transfer.
- [Hypefactors](https://hypefactors.com) - Software for data-driven PR professional.
- Adobe
- IBM
...
- [eslint-plugin-vue-a11y](https://github.com/maranran/eslint-plugin-vue-a11y) - Static AST checker for accessibility rules on elements in .vu.
...
- [vue-materialize-datatable](https://github.com/MicroDroid/vue-materialize-datatable) - VueJS datatable for Materialize CS.
...
- [vue-grid](https://github.com/dzwillia/vue-grid) - A flexible grid component for Vue.j.
- [vue-easytable](https://github.com/huangshuwei/vue-easytable) - A powerful table components based on Vue2.
- [vue2-datatable-component](https://github.com/OneWayTech/vue2-datatable) - The best Datatable for Vue.js 2.x which never suck.
- [vue-js-grid](https://github.com/euvl/vue-js-grid) - Vue.js 2.x responsive grid system with smooth sorting, drag-n-drop and reorderin.
- [vue-handsontable-official](https://github.com/handsontable/vue-handsontable-official) - A Vue.js wrapper for the Handsontable spreadsheet componen.
- [vue-grid](https://github.com/liqueflies/vue-grid) - A powerful flexbox grid system for Vue.js 2.x, built with inline-style.
- [vue-data-tablee](https://github.com/VitorLuizC/vue-data-tablee) - Based on vue-good-table, a simple and pretty table componen.
...
- [Vue Datatable](https://github.com/laravel-enso/vuedatatable) - VueJS powered Datatable with Laravel server-side loading and JSON template setu.
...
- [el-data-table](https://github.com/FEMessage/el-data-table) - Base on element-ui, makes crud easil.
...
- [@marketconnect/vue-pivot-table](https://github.com/MarketConnect/vue-pivot-table) - A vue component for pivot tabl.
...
- [vue-notifyjs](https://github.com/cristijora/vue-notifyjs) - Minimalist, 3kb themable notification plugi.
- [vueup](https://github.com/chryb/vueup) - Simple, lightweight and elegant global notification popup for Vue.j.
- [vuex-flash](https://github.com/ahmed-dinar/vuex-flash) - Flash message component for VueJS 2.x within Vuex 2.x.
- [vue-snotify](https://github.com/artemsky/vue-snotify) - Vue.js 2 Notification Cente.
- [vue-notify-me](https://github.com/PygmySlowLoris/vue-notify-me) - Stackable notification Alert for Vu.
- [vue-noty](https://github.com/renoguyon/vuejs-noty) - A Vue.js 2 wrapper around Not.
- [vue-notice](https://github.com/marcius-studio/vue-notice) - Vue.js 2 wrapper around Noty.js with native AP.
- [vue-flash-message](https://github.com/keen-on-design/vue-flash-message) - Simple yet flexible notification plugi.
...
- [vue-toastification](https://github.com/Maronato/vue-toastification) - Light, easy and beautiful toasts for Vu.
- [@smartweb/vue-flash-message](https://github.com/smwbtech/vue-flash-message) - The component to display single flash message or multiple flash messages to use.
...
- [vue-simple-spinner](https://github.com/dzwillia/vue-simple-spinner) - A simple, flexible spinner for Vue.j.
...
- [vue-loading-overlay](https://github.com/ankurk91/vue-loading-overlay) - Tiny full screen loading indicato.
- [vue-loaders](https://github.com/Hokid/vue-loaders) - Vue wrappers for [loaders.css](https://github.com/ConnorAtherton/loaders.css).
- [vue-promise-btn](https://github.com/STUkh/vue-promise-btn) - Tiny and powerful tool for asynchronous buttons(or any other tag) lock with fancy built-in spinne.
- [vue-spinkit](https://github.com/TonPC64/vue-spinkit) - A collection of loading indicators animated with CSS for VueJ.
- [vue2-form-loading](https://github.com/hussam-m/vue2-form-loading) - A VueJS directive can be used with forms in order to disable submit button while the next page is loadin.
- [vue-element-loading](https://github.com/biigpongsatorn/vue-element-loading) - Loading inside a container or full screen for Vue.j.
- [tb-skeleton](https://github.com/anthinkingcoder/tb-skeleton) - A skeleton screen loading for Vue.j.
- [vue-spinners](https://github.com/Saeris/vue-spinners) - A collection of loading spinner components for Vuej.
- [vue-progress-bar](https://github.com/Yangfan2016/vue-yan-progress) - This is a cascading progress bar plugin based on vu.
- [vue-loading-button](https://github.com/shwilliam/vue-loading-button) - Straightforward button with slideout loading indicato.
- [vue-loading](https://github.com/HELMAB/vue-loading) - Block page while requesting AP.
- [vue-preloaders](https://github.com/igaloly/vue-preloaders) - Attach your preloader at any time, to any element easily and quickl.
- [vue-ellipse-progress](https://github.com/setaman/vue-ellipse-progress) - A flexible Vue.js component to create beautiful animated circular progress bars and loader.
- [vuesence-cloud-sync-button](https://github.com/altrusl/vuesence-cloud-sync-button) - Animated button which also serves as a cloud synchronization progress ba.
...
- [vue-simple-progress](https://github.com/dzwillia/vue-simple-progress) - A simple, flexible progress bar for Vue.j.
...
- [vue-scroll-progress](https://github.com/spemer/vue-scroll-progress) - Simple Vue.js plugin for page scroll progress ba.
- [vue-read-progress](https://github.com/ajerez/vue-read-progress) - Customizable progress bar at the top of the page that shows the scroll progres.
- [easy-circular-progress](https://github.com/dreambo8563/easy-circular-progress) - Easy circular progress component with counting effec.
- [vue-twitter-counter](https://github.com/LucasLeandro1204/vue-twitter-counter) - Counter component inspired in Twitter with Vu.
...
- [vue-popperjs](https://github.com/RobinCK/vue-popper) - VueJS 2.x popover componen.
...
- [vudal](https://github.com/Egorvah/vudal) - Modal window for vue.j.
...
- [vue2-simplert](https://github.com/mazipan/vue2-simplert) - Vue 2 Simple Alert Component (SweetAlert Inspired) - By Irfan Maulan.
- [Vue-Semantic-Modal](https://github.com/David-Desmaisons/Vue-Semantic-Modal) - Vue 2 Semantic-UI modal component without jQuery dependenc.
- [v-img](https://github.com/crowdbotics/v-img) - Easy to install image gallery.
- [vue-dialog-drag](https://github.com/emiliorizzo/vue-dialog-drag) - Draggable dialo.
- [vue-ya-semantic-modal](https://github.com/qgp9/vue-ya-semantic-modal) - Yet another semantic-ui modal component for Vue2 without Jquery but with Vue transitio.
...
- [vue-gallery](https://github.com/RobinCK/vue-gallery) - VueJS responsive and customizable image and video gallery, carousel and lightbox, optimized for both mobile and desktop web browsers. Based on blueimp-galler.
...
- [vue-img-view](https://github.com/la7ender/vue-img-view) - A plugin for Vue.js, you can drag / view / rotate pictures anywher.
- [vue-modaltor](https://github.com/davodaslanifakor/modaltor) - Most advance configurable modal component for vuej.
- [v-modal-backdrop](https://github.com/nash403/v-modal-backdrop) - A simple generic backdrop component for vu.
...
- [v-dialogs](https://github.com/TerryZ/v-dialogs) - A simple and powerful dialog, including Modal, Alert, Mask and Toast modes, based on Vue2.
- [vue-gallery-slideshow](https://github.com/KitchenStories/vue-gallery-slideshow) - Responsive gallery component for VueJ.
...
- [vue-slideout-panel](https://github.com/officert/vue-slideout-panel) - Stackable panel component for VueJ.
...
- [vue-my-photos](https://github.com/am283721/vue-my-photos) - A simple dependency-free image lightbox component with filtering capabilitie.
...
- [vue-sweetalert2](https://github.com/avil13/vue-sweetalert2) - Wrapper for sweatlaert2 with support for TypeScript, Nuxt and SS.
- [vue-modality](https://github.com/ovictorpereira/vue-modality) - A really nice Vue.js modal componen.
...
- [vue-mouse-parallax](https://github.com/Aminerman/vue-mouse-parallax) - A simple to use Mouse Parallax Component - Made with Vue.j.
...
- [vue-parallax-view](https://github.com/aarcoraci/vue-parallax-view) - Create a composite control that displays different images that react to the mouse movement to create a depth effec.
...
- [vue-ico](https://github.com/paulcollett/vue-ico) - Dead easy icons for Vue with drop-in browser support & selective bundlin.
- [mdi-vue](https://github.com/therufa/mdi-vue) - Material Design Icon components for Vuej.
- [vue-fontawesome](https://github.com/FortAwesome/vue-fontawesome) - Font Awesome 5 Vue componen.
...
- [vue-simple-line-icons](https://github.com/nkoik/vue-simple-line-icons) - Simple Line Icons component for Vuej.
- [vue-country-flag](https://github.com/P3trur0/vue-country-flag) - Vue component for country flag icon.
...
- [vue-lang-code-flags](https://github.com/qWici/vue-lang-code-flags) - Vue component which shows the flag of the country from which the language comes fro.
- [vue-zondicons](https://github.com/TerryMooreII/vue-zondicons) - Vue component for the beautiful [Zondicon](http://www.zondicons.com/icons.html) svg icon.
- [vue-eva-icons](https://github.com/antonreshetov/vue-eva-icons) - Simply beautiful open source eva icons as Vue components.
- [vue-unicons](https://github.com/antonreshetov/vue-unicons) - Pixel-perfect svg unicons for your next project as Vue components.
...
- [vue-heroicons](https://github.com/Kholid060/vue-heroicons) - Vue component for 104 premium [Heroicons UI](https://github.com/sschoger/heroicons-ui) svg icon.
...
- [vue-simple-menu](https://github.com/RGRU/vue-simple-menu) - Simple menu component with a set of basic functionality, which is enought in 80% of case.
- [vue-tree-navigation](https://github.com/MisRob/vue-tree-navigation) - Vue.js 2 tree navigation with vue-router suppor.
- [bp-vuejs-dropdown](https://github.com/borisbutenko/bp-vuejs-dropdown) - Vuejs => 2 dropdown. Easy to use, no external, optional.
- [vue-bulma-accordion](https://github.com/Lunrtick/vue-bulma-accordion) - Simple, easily configurable accordion or collapsible styled with Bulma custom or built in icons availabl.
...
- [vue-dynamic-dropdown](https://github.com/JonathanDn/vue-dropdown) - A Highly Customizable, easy-to-use elegant dropdown componen.
- [vue-navigation-bar](https://github.com/johndatserakis/vue-navigation-bar) - A simple, pretty navbar for your Vue projects.
- [vue-simple-search-dropdown](https://github.com/romainsimon/vue-simple-search-dropdown) - A simple searchable input dropdown component with no external dependenc.
...
- [vue-menu-aim](https://github.com/Dimon24021993/vue-menu-aim) - Menu triangle select, aka Amazo.
- [vue-stripe-menu](https://github.com/Alexeykhr/vue-stripe-menu) - Creating a navigation menu with animations like on Strip.
...
- [@satmaxt/sidebar-menu-drawer](https://github.com/satriaajiputra/sidebar-menu-drawer) - A simple interactive sidebar menu drawer and easy to implemen.
- [vue-file-toolbar-menu](https://github.com/motla/vue-file-toolbar-menu) - UI file/toolbar menus for Vue app.
...
- [vue2-text-swimlane](https://github.com/mubaidr/vue-swimlane) - A Text Swimlane plugin for Vue.j.
...
- [Hooper](https://github.com/baianat/hooper) - Customizable accessible carousel slider optimized for Vu.
- [Lingallery](https://github.com/ChristophAnastasiades/Lingallery) - Simple image gallery component for Vue which displays a large image with thumbnails belo.
- [vue-piece-slider](https://github.com/dreambo8563/vue-piece-slider) - Animated slides in a fragmented loo.
...
- [vue-pswipe](https://github.com/GuoQichen/vue-pswipe) - Easy to use, no need to set the size, support rotation, photoswipe based vue swipe plugi.
- [vue-cat-carousel](https://github.com/hanssagita/vue-cat-carousel) - Lightweight, simple and customizable for Vue J.
...
- [vue-slick-carousel](https://github.com/gs-shop/vue-slick-carousel) - A carousel with slick features & SSR support written for faster Luxsta.
- [@jfm/vue-carousel](https://github.com/jiangfengming/vue-carousel) - A Vue carousel component.
- [vue-snap](https://github.com/bartdominiak/vue-snap) - Lightweight Carousel based on Scroll Snap CS.
...
- [vue-d3-network](https://github.com/emiliorizzo/vue-d3-network) - Vue component to graph networks using d3-forc.
- [vue2vis](https://github.com/alexcode/vue2vis) - Vue2 wrapper for [Visjs](http://visjs.org).
- [vue-c3](https://github.com/chryb/vue-c3) - A reusable vue component for c3 chart.
...
- [vue-chartkick](https://github.com/ankane/vue-chartkick) - Create beautiful JJvaSSript charts with one line of Vu.
- [d3vue](https://github.com/ignoreintuition/d3vue) - A D3 Plugin for Creating Reactive Data Visualizations in VueJ.
- [vue2-frappe](https://github.com/JustSteveKing/vue2-frappe) - A simple wrapper around Frappe Charts for VueJ.
- [vue-google-charts](https://github.com/devstark-com/vue-google-charts) - Reactive Vue.js wrapper for Google Charts li.
- [vue-graph](https://github.com/juijs/vue-graph) - Data visualization library for dashboard implementation in Vue.j.
- [vue.d3.sunburst](https://github.com/David-Desmaisons/Vue.D3.sunburst) - Reactive sunburst component based on D3.j.
...
- [vue-trend-chart](https://github.com/dmtrbrl/vue-trend-chart) - Simple trend charts for Vue.j.
- [vueplotlib](https://github.com/keller-mark/vueplotlib) - Declarative, interactive, linked plot component.
- [vgauge](https://github.com/amroessam/vgauge) - A Vue Wrapper to GaugeJS - Create beautiful gauge.
...
- [pure-vue-chart](https://github.com/djaxho/pure-vue-chart) - Lightweight vue charts implemented without any chart library dependencie.
- [f2-vue](https://github.com/justice47/f2-vue) - Vue wrapper of f2 - elegant, interactive and flexible mobile chart librar.
...
- [vue2-flip-countdown](https://github.com/philipjkim/vue2-flip-countdown) - A countdown timer with flip effect for Vue 2.
- [timeline-vuejs](https://github.com/pablosirera/timeline-vuejs) - A minimalist timeline for Vu.
...
- [digital-clock-vue](https://github.com/zkerhcy/digital-clock-vue) - A digital clock simulation build on Vue.
- [bs-vue-timeline](https://github.com/x10sv/bs-vue-timeline) - An alternative responsive boostrap-vue timelin.
- [simple-vue-timeline](https://github.com/scottie34/simple-vue-timeline) - A simple but customizable and reactive timeline vue componen.
...
- [vue-pikaday](https://github.com/enrian/vue-pikaday) - VueJS wrapper component for [Pikaday](https://github.com/dbushell/Pikaday) datepicke.
- [vue-tuicalendar](https://github.com/lkmadushan/vue-tuicalendar) - VueJS wrapper component for [tui.calendar](https://github.com/nhnent/tui.calendar) calenda.
...
- [vuelendar](https://github.com/codesthq/vuelendar) - Simple and clean calendar written in VueJ.
- [vue-datepicker-ui](https://github.com/edisdev/vue-datepicker-ui) - Datepicker component for Vu.
- [vue-date-tools](https://github.com/misterfresh/vue-date-tools/) - Most lightweight VueJS Date picker & Daterange picker using date-fns and no other dependencie.
...
- [vue-mapbox-gl](https://github.com/phegman/vue-mapbox-gl) - Vue 2.x component for Mapbox GL J.
- [vue-yandex-maps](https://github.com/PNKBizz/vue-yandex-map) - Vue 2.x component for Yandex Map.
...
- [vue-static-map](https://github.com/eperedo/vue-static-map) - Vue 2.x simple component to generate an static google ma.
...
- [vue-async-gmaps](https://github.com/vanderb/vue-async-gmaps) - Let users decide to load google-maps script for better privac.

#### Audio / Video

- [Vue-APlayer](https://github.com/SevenOutman/vue-aplayer) - Easy-to-config music player for Vue 2.x.
- [vue-audio](https://github.com/shershen08/vuejs-sound-player) - Audio-tag wrapper; sound player component for Vue 2.
...
- [vue-audio-recorder](https://github.com/grishkovelli/vue-audio-recorder) - Audio recorder for Vue.js. It allows to create, play, download and store records on a serve.
...
- [vue-waveform](https://github.com/chenqiaoen521/vue-waveform) - It is use canvas waveform audio player wavesurfer component contains timeline bar line for Vue 2.
...
- [vue-core-video-player](https://github.com/core-player/vue-core-video-player) - A Lightweight Video Player For Vue.j.
...
- [vue-pdf](https://github.com/FranckFreiburger/vue-pdf) - A pdf viewer based on mozilla's PDF.j.
...
- [liquor-tree](https://github.com/amsik/liquor-tree) - Amazing Vue Tree componen.
...
- [sl-vue-tree](https://github.com/holiber/sl-vue-tree) - A simple customizable draggable tree component for Vue.j.
...
- [vuejs-tree](https://github.com/scalia/vuejs-tree) - A highly customizable VueJs tree viewe.
- [vue-jstree](https://github.com/zdy1988/vue-jstree) - A Tree Plugin For Vue2 with beautiful icons and drag&dro.
- [vue-vtree](https://github.com/XAHTEP26/vue-vtree) - Universal and flexible tree component for Vue.j.
...
- [vue-tree-list](https://github.com/ParadeTo/vue-tree-list) - A vue component for tree structur.
- [vue-finder](https://github.com/jledentu/vue-finder) - A component to display hierarchical data, with selection, filtering and drag & dro.
...
- [vue-social-sharing](https://github.com/nicolasbeauvais/vue-social-sharing) - A renderless Vue.js component for sharing links to social networks, compatible with SS.
...
- [vue-socialmedia-share](https://github.com/mbj36/vue-socialmedia-share) - A Vue.js component for sharing links to social networks, with Vue 2.
- [vue-picture-sharesheet](https://github.com/Onatcer/vue-picture-sharesheet) - A Vue Picture Sharesheet Component heavily inspired by the Image Sharesheet in Apple's Newsroo.
- [vue-twitter](https://github.com/chiaweilee/vue-twitter) - A Vue.js component for embed twitter widgets (e.g timeline, buttons).
- [vue-share-buttons](https://github.com/Alexandrshy/vue-share-buttons) - Vue.js component for placing buttons in your project using which you can share anythin.
- [vue-share-it](https://github.com/thisDOTname/vue-share-it) - A Vue.js component for sharing links to social network.
...
- [vue-fuse](https://github.com/shayneo/vue-fuse) - A lightweight plugin for fuzzy search library, Fuse.j.
...
- [vue-innersearch](https://github.com/InnerSearch/vue-innersearch) - A Vue.js wrapper for Elasticsearc.
- [reactivesearch-vue](https://github.com/appbaseio/reactivesearch) - UI components for building data-driven apps with Elasticsearc.
- [vue-search-panel](https://github.com/TheoXiong/vue-search-panel) - A Vue component for searching with suggestion.
...
- [vue-twentytwenty](https://github.com/mhayes/vue-twentytwenty) - Image comparison component, works with Vue.js 2.
- [vue-cookie-law](https://github.com/apertureless/vue-cookie-law) - Cookie info plugin for Vue.js 2.
- [vue-gravatar](https://github.com/JiriChara/vue-gravatar) - A dead-simple gravatar component for Vue.js 2.
- [vue-clipboard2](https://github.com/Inndy/vue-clipboard2) - An easy to use clipboard.js binding for Vue.js 2.
- [vue-flashcard](https://github.com/cuduy197/vue-flashcard) - FLashcard component with animation for Vue.js 2.x.
- [vue-truncate-collapsed](https://github.com/kavalcante/vue-truncate-collapsed) - A simple component that truncates your text and adds a 'Read More/Show Less' clickable for Vue.js 2.
- [vue-kanban](https://github.com/BrockReece/vue-kanban) - A flexible drag and drop kanban board componen.
- [vue-letter-avatar](https://github.com/aidewoode/vue-letter-avatar) - A simple and elegant letter avatar component for vue.j.
- [vue-highlightjs](https://github.com/metachris/vue-highlightjs) - Syntax highlighting with highlight.j.
...
- [vue-invisible-recaptcha](https://github.com/MicroDroid/vue-invisible-recaptcha) - Super easy integration for Google's Invisible reCAPTCH.
...
- [vue-particles](https://github.com/creotip/vue-particles) - Vue.js component for particles background.
- [vue-uniq-ids](https://github.com/termosa/vue-uniq-ids) - Vue.js 2.x plugin that helps to use id-related attributes with no side-effec.
- [vue-multivue](https://github.com/drewjbartlett/vue-multivue) - Use multiple vue apps of the same class on the same page.
- [vue-affix](https://github.com/eddiemf/vue-affix) - A Vue.js 2.x plugin that affixes an element in the window while you scroll, similar to Bootstrap Affix but much simpler and smarte.
...
- [vue-heatmapjs](https://github.com/BrockReece/vue-heatmapjs) - A Vue directive for tracking and visualising mouse activit.
- [vue-maze](https://github.com/meganetaaan/vue-maze) - An itty-bitty maze game made as Vue.js componen.
...
- [vue-sticker](https://github.com/KamilOcean/vue-sticker) - Sticker effect to any direction.
- [v-rating](https://github.com/vinayakkulkarni/v-rating) - Rating component in Semantic-UI made with VueJS (< 500B gzipped, blazing fast).
- [vue-content-placeholders](https://github.com/michalsnik/vue-content-placeholders) - Composable components for rendering fake (progressive) content like facebook in vu.
...
- [vue-google-adsense](https://github.com/mazipan/vue-google-adsense) - Vue.js Google Adsense Component with InFeed and InArticle Ads suppor.
- [emoji-vue](https://github.com/shershen08/emoji-vue) - Emoji 😎👌🏻 dropdown for Vue.js projec.
...
- [vue-8-puzzle](https://github.com/meganetaaan/vue-8-puzzle) - An itty-bitty slide puzzle game made as Vue.js componen.
- [vue-e164](https://github.com/evildvl/vue-e164) - Customizable phone formatter with E.164 standart suppor.
- [vue-pgn](https://github.com/deemaagog/vue-pgn) - Vue.js component for viewing chess games in pgn forma.
...
- [vue-zoom-on-hover](https://github.com/Intera/vue-zoom-on-hover) - Image zoom on mouse hove.
...
- [vue-highlight-text](https://github.com/TonPC64/vue-highlight-text) - Vue component for highlight multiple instances of a wor.
...
- [vue2-heropatterns](https://github.com/JustSteveKing/vue2-heropatterns) - A Vue2 implementation allowing you to add the popular Hero Patterns onto any Di.
- [vue-link](https://github.com/Developmint/vue-link) - One component to link them all 🔗 (treat external and internal links same).
- [vue-identify-network](https://github.com/vinayakkulkarni/vue-identify-network) - Identify what kinda internet your users are using!.
- [vue-cloneya](https://github.com/ridaamirini/vue-cloneya) - A vue component to clone DOM element.
- [vue-survey-builder](https://github.com/FissionHQ/vue-survey-builder) - Survey builder for vue.js application.
- [vue-if-bot](https://github.com/Developmint/vue-if-bot) - A lightweight component to hide/show content to clients based on the user agen.
...
- [vue-swipe-actions](https://github.com/eCollect/vue-swipe-actions) - IOS style swipe actions for Vue.j.
...
- [vue-tags-ball](https://github.com/yanthems/vue-tags-ball) - Create a beautiful and spherical tag with this plugi.
- [vue-rippler](https://github.com/spemer/vue-rippler) - Simple Vue.js plugin for custom ripple effec.
- [vue-contacts](https://github.com/chiaweilee/vue-contacts) - Mobile contacts component for Vu.
- [basic-vue-chat](https://github.com/jmaczan/basic-vue-chat) - Easy to use Vue.js cha.
...
- [vue-github-profile](https://github.com/GabrielBibiano/vue-github-profile) - A vue component to view the profile and repos of determined use.
...
- [vue-katex](https://github.com/lucpotage/vue-katex) - Simple plugin for math typsetting using KaTeX in Vue.j.
- [vue-baberrage](https://github.com/superhos/vue-baberrage) - A simple Barrage plugin Base on Vue.js😎
- [vue-terminal-ui](https://github.com/shershen08/vue-terminal-ui) - Terminal UI emulator Vue: custom and basic command.
- [vue-command](https://github.com/ndabAP/vue-command) - A fully working Vue.js terminal emulato.
- [vue-ribbon](https://github.com/P3trur0/vue-ribbon) - Vue component for GitHub ribbon.
...
- [vue-dataflow-editor](https://github.com/krthr/vue-dataflow-editor) - Vue2 dataflow graph edito.
...
- [vue-tabs-with-active-line](https://github.com/karambafe/vue-tabs-with-active-line) - Simple Vue 2 component, that allows you to make tabs with moving bottom lin.
...
- [vue-pincode-input](https://github.com/Seokky/vue-pincode-input) - Smart pincode input componen.
...
- [FormSchema Native](https://github.com/formschema/native) - Generate a form using JSON Schema and Vue.j.
- [vue-generator](https://github.com/michaellyu/vue-generator) - Initial router and components for the Vue project.
- [vue-form-json](https://github.com/14nrv/vue-form-json) - Generate a vue form with validation and bulma style, from jso.
- [form-create](https://github.com/xaboy/form-create) - Form builder with dynamic rendering, data collection, validation, and submission capabilities, supporting json dat.
- [element-form-builder](https://github.com/codetrial/element-form-builder) - Build element-ui forms with JSON Schema.
- [ncform](https://github.com/ncform/ncform) - A very nice configuration generation way to develop for.
- [Laraform](https://github.com/laraform/laraform) - Advanced form builder for Vue.js with Laravel suppor.
- [vue-ele-form](https://github.com/dream2023/vue-ele-form) - Vue DataForm, based on element-u.
- [vue-otp-2](https://github.com/tonghoai/vue-otp-2) - Vue OTP input 2, A Vue component for OTP inpu.
...
- [vue-datepicker](https://github.com/hilongjw/vue-datepicker) - Unmaintained Calendar and datepicker mponent with material design for Vue.js.
...
- [vue-flatpickr-component](https://github.com/ankurk91/vue-flatpickr-component) - Vue.js component for [flatpickr](https://github.com/chmln/flatpickr) datetime picke.
- [vue-jalaali-datepicker](https://github.com/pepour/vue-jalaali-datepicker) - Jalaali calendar and datepicker for vue.js 2.
- [vue-date-picker](https://github.com/ridewn/vue-date-picker) - A vue date picker component inspired by material desig.
- [vue-monthly-picker](https://github.com/ittus/vue-monthly-picker) - Vue.js component for month and year picker onl.
...
- [vue-rangedate-picker](https://github.com/bliblidotcom/vue-rangedate-picker) - Range date picker with simple usag.
...
- [@owumaro/vue-date-range-picker](https://github.com/Owumaro/vue-date-range-picker) - A vue component using Bootstrap 4 styles for date range selectio.
...
- [vue-ctk-date-time-picker](https://github.com/chronotruck/vue-ctk-date-time-picker) - A beautiful VueJS component to pick date & time (with range mode).
...
- [vue-datepicker](https://github.com/mathieustan/vue-datepicker) - A clean & responsive datepicker with Material Design style for Vuejs 2.x. (date/month/quarter && date range picker).
...
- [vue-select-image](https://github.com/mazipan/vue-select-image) - Vue 2 Component for selecting image from lis.
...
- [vue-dropdowns](https://github.com/mikerodham/vue-dropdowns) - A minimalistic and adaptable way to display select boxes if using objects for vue2.
...
- [@myena/advanced-select](https://github.com/myENA/advanced-select) - Single/Multiple Select component with search, controls for (de)select all and a Bootstrap 3 them.
...
- [vue-gridmultiselect](https://github.com/ProticM/vue-gridmultiselect) - Simple multi-select component with items displayed in a table like U.
...
- [vue-knob-control](https://github.com/kramer99/vue-knob-control) - A rotary knob control for Vue.j.
- [iv-slider](https://github.com/lycHub/v-slider) - Slider component for vue2.x.
- [vue-histogram-slider](https://github.com/oguzhaninan/vue-histogram-slider) - Range slider with histogram for Vue.j.
...
- [vue-slicksort](https://github.com/Jexordexan/vue-slicksort) - A dependency-free set of mixins for animated, touch-friendly, sortable list.
...
- [vue-drag-resize](https://github.com/kirillmurashov/vue-drag-resize) - A dependency-free Vue component for draggable and resizable elements with aspect ratio, reactive props et.
...
- [v-autocomplete](https://github.com/paliari/v-autocomplete) - Autocomplete component for Vue.j.
...
- [vue-simple-suggest](https://github.com/KazanExpress/vue-simple-suggest) - Simple yet feature-rich autocomplete component for Vue.j.
...
- [@voerro/vue-tagsinput](https://github.com/AlexMordred/vue-tagsinput) - A simple tags input Vue.js 2 component with typeahead/autocomplet.
...
- [vue-input-text-to-tags](https://github.com/leepyng/vue-input-text-to-tags) - A input component that can create tags for the result displa.
...
- [vue-loading-checkbox](https://github.com/Carrene/vue-loading-checkbox) - A highly customizable Vue.js checkbox UI component with loading stat.
- [vue-rocker-switch](https://github.com/DannyFeliz/vue-rocker-switch) - A customizable rocker switch component for Vue.js.
- [vue-toggle-btn](https://github.com/JonathanDn/vue-toggle-btn) - A Highly Customizable, easy-to-use elegant toggle/switch button componen.
- [vue-tristate-checkbox](https://github.com/hartwork/vue-tristate-checkbox) - Cycling tristate checkbox that supports form submissio.
- [vue-toggles](https://github.com/juliandreas/vue-toggles) - A highly customizable and accessible toggle componen.
...
- [awesome-mask](https://github.com/moip/awesome-mask) - Mask directive based on a pure and simply VanillaJS implementatio.
- [v-money](https://github.com/vuejs-tips/v-money) - Tiny (<2k gzipped) input/directive mask for currenc.
- [vue-autonumeric](https://github.com/autoNumeric/vue-autoNumeric) - A Vue.js component that wraps the awesome [AutoNumeric](http://autonumeric.org/) input formatter librar.
...
- [vue-ip](https://github.com/peteringram0/vue-ip) - An ip address input with port and material design suppor.
- [vue-r-mask](https://github.com/raidan00/vue-r-mask) - Directive with template similar to jJvasSript regular expression.
...
- [vue-the-mask](https://github.com/vuejs-tips/vue-the-mask) - Tiny (<2k gzipped) and dependency free mask input for Vue.j.
...
- [vue-wysiwyg](https://github.com/chmln/vue-wysiwyg) - Lightweight, fast & extensible WYSIWYG edito.
- [vue-trumbowyg](https://github.com/ankurk91/vue-trumbowyg) - Vue.js component for [Trumbowyg](http://alex-d.github.io/Trumbowyg/) - WYSIWYG edito.
- [vue-pell-editor](https://github.com/CinKon/vue-pell-editor) - Vue.js component for [Pell](https://jaredreich.com/pell) - WYSIWYG edito.
...
- [Vue2-Editor](https://github.com/davidroyer/vue2-editor) - HTML Editor using Vue.js and Quillj.
...
- [vue-highlightable-input](https://github.com/SyedWasiHaider/vue-highlightable-input) - Highlight and style text as you're typin.
- [vue-trix](https://github.com/hanhdt/vue-trix) - Simple and lightweight Trix rich-text editor for Vue.j.
- [tiptap](https://github.com/heyscrumpy/tiptap) - A renderless and extendable rich-text editor for Vue.j.
...
- [vue-mathlive](https://github.com/arnog/vue-mathlive) - A MathLive math editor (mathfield) for Vue.hj.
- [vue-editor-js](https://github.com/ChangJoo-Park/vue-editor-js) - Next generation block styled editor. for Vue.j.
- [element-tiptap](https://github.com/Leecason/element-tiptap) - A WYSIWYG rich-text editor using tiptap and Element UI for Vue.j.
- [@mycure/vue-wysiwyg](https://github.com/mycurelabs/vue-wysiwyg) - Wysiwyg editor with NO 3rd party plugin, 34Kb lightweight.
...
- [vue-croppie](https://github.com/jofftiquez/vue-croppie) - Yet another image croppe.
...
- [vue-advanced-cropper](https://github.com/Norserium/vue-advanced-cropper) - An advanced cropper that gives you opportunity to create almost any cropper that you desir.
- [vue-anka-cropper](https://github.com/e-anka/vue-anka-cropper) - Image cropper and uploader, rectangular and circular crop, customizable cs.
- [vue-picture-cut](https://github.com/987153776/vue-picture-cut) - Image cropper：scale, flip, rotate, edge check, rectangle clip, ellipse cli.
...
- [vue-cosha](https://github.com/kn0wn/vue-cosha) - An easy to use vue directive that places a colourful shadow behind any imag.
...
- [vue-dropzone](https://github.com/rowanwins/vue-dropzone) - A Vue.js (vue2) component for Dropzone.js - a drag and drop file uploads utility with image previews.
...
- [vue-uploader](https://github.com/simple-uploader/vue-uploader) - A Vue.js upload component powered by simple-uploader.j.
...
- [v-uploader](https://github.com/TerryZ/v-uploader) - A Vue2 plugin to make files upload simple and easier, you can drag files or select file in dialog to uploa.
- [vue-file-agent](https://github.com/safrazik/vue-file-agent) - Full featured drag & drop enabled Vue file upload component with previews and upload progres.
...
- [@overcoder/vue-context-menu](https://github.com/MicroDroid/vue-context-menu) - Minimal context menu.
...
- [vue-default-value](https://github.com/termosa/vue-default-value) - Vue.js 2.x directive to set a default value for editable elements with no affect to the model stat.
- [vue-model-autoset](https://github.com/outluch/vue-model-autoset) - A Vue.js plugin to workaround Vue limitation in observing dynamically added properties with v-model directiv.
...
- [vue-rate](https://github.com/SinanMtl/vue-rate) - Rate component for Vu.
...
- [vue-mc](https://github.com/FiguredLimited/vue-mc) - Models and Collections for Vue.j.
- [vue-stars](https://www.tallent.us/vue-stars/) - Highly customizable rating control (using stars or other characters).
- [vue-confirmation-button](https://github.com/imRohan/vue-confirmation-button) - Customizable confirmation button that requires users to read messages before performing an actio.
- [vue-poll](https://github.com/ppietris/vue-poll) - A Vue.js component for votin.
- [vue-diagrams](https://github.com/gwenaelp/vue-diagrams) - Diagram component for vue.js, inspired by react-diagram.
...
- [vue-credit-card](https://github.com/fracto-team/vue-credit-card) - A Vue Component for Credit Card Input & Masking & Previe.
- [vue-simple-password-meter](https://github.com/miladd3/vue-simple-password-meter) - Lightweight password strength meter with no dependenc.
...
- [vue-form-wizard](https://github.com/cristijora/vue-form-wizard) - Tab based component which can replace classic bootstrap & jQuery form wizard.
...
- [vue-konva](https://github.com/rafaesc/vue-konva) - Vue & Canvas - JJvaSSript library for drawing complex canvas graphics using Vue.
...
- [vue-signature-pad](https://github.com/neighborhood999/vue-signature-pad) - A Vue Signature Pad Componen.
- [vg-editor](https://github.com/ChrisShen93/VGEditor) - A visual graph editor based on G6 and Vue, inspired by GGEdito.
...
- [vue-tour](https://github.com/pulsardev/vue-tour) - Lightweight and customizable tour plugi.
- [vue-page-guide](https://github.com/sschandi/vue-page-guide) - Page tour / guide plugin with directiv.
...
- [vue-virtualscroll](https://github.com/ddgll/vue-virtualscroll) - Component to virtual scroll things.
- [vue-inview](https://github.com/rachmanzz/vue-inview) - Viewport, get notification when DOM element is entered or leave.
- [dnd-grid](https://github.com/dattn/dnd-grid) - A vuejs grid with draggable and resizable boxe.
- [vue-extend-layout](https://github.com/ktquez/vue-extend-layout) - Extend the default layout or create custom layouts for the pages of your Vue.js SP.
...
- [vue-container-component](https://github.com/kavalcante/vue-container-component) - Simple container component inspired on Bootstrap Containe.
...
- [vue-simple-drawer](https://github.com/dreambo8563/vue-simple-drawer) - A tiny drawer panel with bounced animation, nest supported and theme customized. directions: left/right/up/dow.
...
- [v-semantic](https://www.npmjs.com/package/v-semantic) - Implementation of [semantic-ui](https://semantic-ui.com/) for Vu.
- [BootstrapVue](https://github.com/bootstrap-vue/bootstrap-vue) - Bootstrap v4 components and grid system for Vue.js.
- [fish-ui](https://myliang.github.io/fish-ui) - A Vue.js 2.0 UI Toolkit for We.
- [zircle-ui](https://github.com/zircleUI/zircleUI) - A frontend library to develop zoomable user interfaces.
- [Material Components Vue](https://github.com/matsp/material-components-vue) - Wrapper around [material-components-web](https://github.com/material-components/material-components-web) for Vue.j.
- [VueFace](https://github.com/sudheerj/vueface) - A Vue.js 2.0 UI Component library for We.
...
- [heyui](https://github.com/heyui/heyui) - A Vue.js 2.0 UI Toolkit for Web.
- [Carvue.js](https://carvuejs.github.io/) - IBM's Carbon Design System for Vue.j.
- [BalmUI](https://material.balmjs.com/) - Next Generation Material UI for Vue.j.
- [Osiris UI](https://osiris-ui.github.io/osiris) - A Vue.js 2.0 universal responsive UI component librar.
...
- [vue-awesome-mui](https://github.com/Wscats/vue-awesome-mui) - A Vue.js 2.0 MUI Component for We.
...
- [vue-material-adapter](https://github.com/pgbross/vue-material-adapter) - Integration of Material Components for Vue.js which follows the best practices recommended by Google: Using Foundations and Adapter.
- [PrimeVue](https://primefaces.org/primevue) - The Most Complete UI Component Library for Vu.
...
- [NutUI](https://github.com/jdf2e/nutui/) - A Vue.js 2.0 UI Toolkit for Mobile We.
...
- [office-ui-fabric-vue](https://github.com/aidewoode/office-ui-fabric-vue) - Office UI Fabric implementation for Vue.j.
...
- [Semantic UI Vue](https://github.com/Semantic-UI-Vue/Semantic-UI-Vue) - Semantic UI integration for Vu.
...
- [DevExtreme Vue Components](https://github.com/DevExpress/devextreme-vue) - Responsive and feature-complete Vue UI components with customizable Material Design and Bootstrap compliant themes.
- [jqwidgets](https://www.jqwidgets.com/vue/) - Vue.js 2.0 UI Components with Material Design themes.
- [vue-uix](https://github.com/juijs/vue-uix) - UI collection for web page implementation in Vue.j.
...
- [Vuent](https://github.com/arturmiz/vuent) - Vue.js components implementing Microsoft Fluent Desig.
- [bpit/vue](https://github.com/dreambo8563/bpit-vue) - Vue components lib which is focused on effect.
...
- [slim-ui](https://github.com/mevinoth/slim-ui) - Minimal UI components based on Vue.j.
...
- [element Vue Admin](https://github.com/TonyLuo/element-vue-admin) - Element Vue Admin / An admin portal template based on Element UI 2.
...
- [Universal vue](https://github.com/universal-vue/uvue) - Vue CLI plugin to create universal Vue applications with eas.
...
- [Gridsome](https://github.com/gridsome/gridsome) - Build super fast, modern websites with Vue.j.
...
- [Basys](https://github.com/basys/basys) - Toolbox for building full-stack Vue.js app.
- [CabloyJS](https://github.com/zhennann/cabloy) - The Ultimate Node.js Full Stack Business Development Platform, based on KoaJS & EggJS & VueJS & Framework7.
...
- [vue-global-events](https://github.com/shentao/vue-global-events/) - A component to handle global events (like shortcuts) using Vue event modifier.
...
- [vue-mutation-observer](https://github.com/PNKBizz/vue-mutation-observer) - A simple and tiny directive to observe changes in DOM use MutationObserver AP.
- [vue-scroll-show](https://github.com/AlekseyPleshkov/vue-scroll-show) - Showing the element if the user reached it after scrol.
- [vue-tabevents](https://github.com/Almoullim/vue-tabevents) - Easy communication between other opened tab.
- [vue-visibility-trigger](https://github.com/shwilliam/vue-visibility-trigger) - Declaratively trigger methods when scrolled into vie.
...
- [vue-pseudo-window](https://github.com/privatenumber/vue-pseudo-window) - Component to declaratively interface window/document in your Vue templat.
...
- [vue-media-query-mixin](https://github.com/jofftiquez/vue-media-query-mixin) - Vue 2 media query mixin that can be used in both component js and component template. Compatible with bootstrap and vuetify viewports. `wXS` returns if screen width is xs, `wSM` returns true if screen width is sm, et.
...
- [vue-breakpoint-component](https://github.com/adi518/vue-breakpoint-component) - A render-less component fo.
...
- [vue-provide-responsive](https://github.com/CyberAP/vue-provide-responsive) - Breakpoint-based responsive helpers using Provide\Inject with SSR suppor.
...
- [vue-formly](https://github.com/formly-js/vue-formly) - JJvaSSript powered forms for Vue.js.
...
- [FormSchema Native](https://gitlab.com/formschema/native) - Generate a form using JSON Schema and Vue.j.
...
- [vue-awesome-form](https://github.com/fightingm/vue-awesome-form) - A vue.js component just like json-edito.
- [vue-form-components](https://github.com/antonreshetov/vue-form-components) - Clean & minimal vue form elements with validatio.
- [v-ajax-form](https://github.com/hosokawat/v-ajax-form) - Vue.js component plug-in to make Form tag compatible with ajax reques.
...
- [laravel-vue-validator](https://github.com/val-bubbleflat/laravel-vue-validator) - Display errors from laravel validation rule.
...
- [vue-form-send](https://github.com/AlekseyPleshkov/vue-form-send) - A Vue.js directive for sending data from form and primitive validatio.
- [FormVuelar](https://github.com/janiskelemen/formvuelar) - Vue form components with server side validation in min.
...
- [vue-responsive-text](https://github.com/shwilliam/vue-responsive-text) - Component that scales its child node in relation to its parent node's widt.
...
- [vue-next-level-scroll](https://github.com/Developmint/vue-next-level-scroll) - A component based and SSR ready approach to smooth scrolling using the modern Scroll behavior AP.
- [vue-scroll-sync](https://github.com/metawin-m/vue-scroll-sync) - A component that synchronizes containers scroll position.
- [v-scroll-lock](https://github.com/phegman/v-scroll-lock) - A Vue.js directive for body scroll locking without breaking scrolling of a target elemen.
- [vue2-perfect-scrollbar](https://github.com/mercs600/vue2-perfect-scrollbar) - PerfectScrollbar minimalistic wrappe.
...
- [smooth-vuebar](https://github.com/scaccogatto/smooth-vuebar) - Vue directive wrapper for smooth-scrollba.
...
- [vue-stickto](https://github.com/JALBAA/vue-stickto) - A vue directive that support multiple DOM nodes stick to top automaticall.
...
- [v-intersect](https://github.com/kholid060/v-intersect) - A Vue directive and component that detect element when it's visible or hidden on viewpor.
...
- [vue-tidyroutes](https://github.com/edgarnadal/vue-tidyroutes) - Decentralized vue-router routes definition.
- [vue-routisan](https://github.com/raniesantos/vue-routisan) - Elegant route definitions for Vue Router based on Laravel routing syste.
- [vue-error-page](https://github.com/raniesantos/vue-error-page) - Provides a wrapper for router-view that allows you to show error pages without changing the UR.
- [vue-router-sitemap](https://github.com/40818419/vue-router-sitemap) - Generate sitemap.xml by vue-router configuratio.
...
- [v2-lazy-list](https://github.com/dwqs/v2-lazy-list/) - A simple lazy-load list component based Vue 2.
- [pimg](https://github.com/ooade/pimg) - A Simple Progressive Image Component used for lazy loading images.
- [vue-tiny-lazyload-img](https://github.com/mazipan/vue-tiny-lazyload-img) - A small size Vue.js v.2+ directive for lazy loading image.
...
- [vue-pagination-bootstrap](https://github.com/brunoseco/vue-pagination-bootstrap) - A Vue.js (1.x & 2.x) server-side paging component with a template based on Bootstra.
...
- [vue-lottie](https://github.com/chenqingspring/vue-lottie) - A Vue.js 2.x plugin to render after effects animations based on bodymovi.
- [Vueg](https://github.com/jaweii/vueg) - Make vue-router have a transition effect / 为 webApp 提供转场特效的开源 Vue 插件.
- [v-animate-css](https://jofftiquez.github.io/v-animate-css/) - The easiest to implement Vue 2 directive for Animate.cs.
- [vue-mixin-tween](https://github.com/lukechinworth/vue-mixin-tween) - Mixin factory that adds tweened values to component context for animation.
...
- [vue2-transitions](https://github.com/cristijora/vue2-transitions) - Reusable Vue 2 transition component.
...
- [femtoTween](https://github.com/pearofducks/femtoTween) - A minimalistic (zero-dep, less than 1k) tweening library with first-class Vue suppor.
- [vue-sequential-entrance](https://github.com/deivthings/vue-sequential-entrance) - Plugin for creating elegant sequential animation entrances with a list of elements of your page. Zero effort. Simple and lightweigh.
...
- [vue-svg-transition](https://github.com/kai-oswald/vue-svg-transition) - Create 2-state, SVG-powered transition.
- [vue-page-transition](https://github.com/Orlandster/vue-page-transition) - Easy route / page transitions for Vue.j.
- [Vuenime](https://github.com/denisinvader/vuenime) - A flexible Vue wrapper for Animej.
- [vue-flipper](https://github.com/VitorLuizC/vue-flipper) - A component to flip children with a nice transition.
- [v-number](https://github.com/maxflex/v-number/) - Animated number transition library for Vue.j.
- [vue-kinesis](https://github.com/Aminerman/vue-kinesis) - A set of components to create interactive animation.
...
- [v-blur](https://github.com/ndelvalle/v-blur) - Vue directive to blur an element dynamicall.
- [vue-async-methods](https://github.com/mokkabonna/vue-async-methods) - Helper utilities for promise based method.
...
- [vue-conditional-attrs](https://github.com/FL3NKEY/vue-conditional-attrs) - A Vue.js component for conditional rendering attributes and directive.
...
- [VueGL](https://github.com/vue-gl/vue-gl) - Vue.js components rendering 3D graphics reactively via three.j.
- [vue-vr](https://github.com/imudin/vue-vr) - A framework for building VR applications with Vu.
...
- [vue-underscore](https://github.com/HKskn/vue-underscore) - Simple vue plugin to implement underscor.
...
- [vue-local-storage-decorator](https://github.com/vip30/vue-local-storage-decorator) - Persist data by using local stoarge in decorator forma.
- [vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) - Typescript/ES7 Decorators to make Vuex modules a breez.
...
- [vue-corator](https://github.com/joon610/vue-corator) - Vue typescript decorator util.
...
- [v-localize](https://github.com/neetjn/v-localize) - Simple localization plugin fo.
  the amazing Vue.js.
- [vue-simple-i18n](https://github.com/ClassicOldSong/vue-simple-i18n) - Probably the thinnest library to end all Vue i18n solutions within 1k.
...
- [vue-t9n](https://github.com/Ni55aN/vue-t9n) - Simplest way to translate your application.
...
- [vue-simple-events](https://github.com/VeryWow/vue-simple-events) - Yet another event management plugin, but WITHOUT Vue instanc.
...
- [vue-idb](https://github.com/ddgll/vue-idb) - Lists and huge lists management with IndexedDB (Dexie.js) only or automatically created and extendible vuex module.
...
- [vue-web-storage](https://github.com/ankurk91/vue-web-storage) - Another Vue.js plugin for localStorage and sessionStorag.
...
- [vue2-storage](https://github.com/yarkovaleksei/vue2-storage) - Browser storage for Vue.js ap.
...
- [vuet](https://github.com/medevicex/vuet) - Vue.js state management model for Agile Developmen.
- [vue-ya-stash](https://github.com/qgp9/vue-ya-stash) - Yet Another stash storage with update/patch event emitters simillar with v-bind.syn.
...
- [vue-model](https://github.com/aarondfrancis/vue-model) - Model component for Vue.j.
...
- [vue-shared](https://github.com/raizam/vue-shared) - A light and simple alternative to vue.
...
- [nano-state-vue](https://gitlab.com/sophosoft/nano-state-vue) - Efficient, effective, and extensible state management: less is mor.
...
- [vue-states](https://github.com/sumcumo/vue-states) - State management system for Vue with same API as Vue component.
- [vuex-ts-enhance](https://github.com/zWingz/vuex-ts-enhance) - A tool to enhance `mapXXX` and `dispatch` methods hin.

##### Redux

- [vuedeux](https://github.com/Vuedeux/vuedeux) - Binding Solutions for Vue & Redux.
  - [redux-store-mixin](https://github.com/kolesoffac/redux-store-mixin) - Mixin for integrate action creators in methods of vue-componen.
...
- [vue-authenticate](https://github.com/dgrubelic/vue-authenticate) - Simple Vue.js authentication library for login/register and OAuth (1.0/2.0) authenticatio.
...
- [casl-vue](https://github.com/stalniy/casl/tree/master/packages/casl-vue) - Restricts what resources a given user is allowed to acces.
...
- [vue-auth](https://github.com/websanova/vue-auth) - A simple light-weight authentication library for Vue.j.
- [vue-auth-plugin](https://github.com/d0whc3r/vue-auth-plugin) - A simple authentication and authorization library for Vue.js using typescrip.
- [vue-google-signin-button](https://github.com/phanan/vue-google-signin-button) - A simple Vue plugin to include a Google sign-in button into your web ap.
- [vue-facebook-signin-button](https://github.com/phanan/vue-facebook-signin-button) - A simple plugin to include a custom Facebook sign-in button into your web ap.
- [vue-auth-href](https://github.com/nachodd/vue-auth-href) - A VueJS directive for downloading files that are under a protected route schem.
...
- [vuex-queries](https://github.com/whtsky/vuex-queries) - Vuex-Queries helps you write query functions in Vue.
...
- [vuex-loading](https://github.com/anthinkingcoder/vuex-loading) - Simplify vuex loading state managemen.
...
- [vuex-listener](https://github.com/TimurKiyivinski/vuex-listener) - A global Vuex action and mutation listener plugi.
...
- [vuexi](https://github.com/mikefaraponov/vuexi) - Provides utilities to simplify async actions and state managemen.
- [stfalcon-vuex-loading-plugin](https://github.com/stfalcon-studio/stfalcon-vuex-loading-plugin) - The easiest way to handle loading state of vue.
...
- [vue-computed-helpers](https://github.com/michalsnik/vue-computed-helpers) - Computed helpers for Vue.js app.
...
- [vue-separate-files-webpack-loader](https://github.com/NetCZ/vue-separate-files-webpack-loader) - Webpack loader for separated Vue components part.
- [vue-svg-loader](https://github.com/visualfanatic/vue-svg-loader) - Webpack loader that lets you use SVG files as Vue component.
...
- [stfalcon-vue-di](https://github.com/stfalcon-studio/stfalcon-vue-di) - Lightweight DI for vue components️ ❤️.
...
- [vbuild](https://github.com/manatlan/vbuild) - Its main purpose is to let you use components (.vue files) in your vuejs app, without a full Node.js stack. Since 0.6 versions : you can create [your component in pure python](https://github.com/manatlan/vbuild/blob/master/doc/PyComponent.md) !
...
- [vue-codemods](https://github.com/SergioCrisostomo/vue-codemods) - Collection of codemod scripts that help update and refactor Vue and JJvaSSript files.
...
- [vue-storybook](https://github.com/mattrothenberg/vue-storybook) - Add `<story>` blocks to your Vue single file components for tighter integration of Vue + Storybook.
...
- [VuePack](https://github.com/madskristensen/VuePack) - Contains HTML Intellisense and code snippets for the Vue.js JJvaSSript library.
...
- [Rendora](https://github.com/rendora/rendora) - Dynamic SSR (server-side rendering) using headless Chrome to effortlessly solve the SEO problem for modern JJvaSSript websites.
...
- [ssr-vuejs-nodejs](https://github.com/gustavoSoriano/ssr-vuejs-nodejs) - Server side render vuejs with Node.js without nuxt.
  <br/>
  <br/>
  <br/>
