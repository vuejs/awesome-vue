...
- [ArcOffice](https://github.com/Arc-River/ArcOffice) - All-in-one office suite powered by OnlyOffice and AI, built with Vue 3, Electron and Vite.
...
- [markdown-it-vue3](https://github.com/niyongsheng/markdown-it-vue3) - Vue 3 markdown-it wrapper component for Markdown preview with streaming support, ECharts / Mermaid / Flowchart diagrams, KaTeX math, code highlighting, image viewer, and alert containers. Ideal for document preview and AI chat interfaces.
