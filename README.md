...
- [localize-vue-2x](https://github.com/uiwebkit/localize-vue-2x) - Uni Localization Vue 2 integration example, with the fully customizable Language Menu widget and the custom translations. Powered by UiWebKit.
