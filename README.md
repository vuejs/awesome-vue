...
- [Saleina CMS](https://gitlab.com/saleina/SaleinaCMS) A static site content management system built with vue using git as a backend.
...
*Integrate with services or other frameworks*
 ...
 - [vue-web3](https://github.com/morrislaptop/vue-web3) - Web3 blockchain bindings for Vue.js (inspired by Vuefire and Drizzle)
  ...
  - [vbuild](https://github.com/manatlan/vbuild) - Its main purpose is to let you use components (.vue files) in your vuejs app, without a full nodejs stack. Just use python2 or python3. BTW, it provides a method to minimize your js scripts (es2015 compliant).
