...
*Virtual scrollbar*
 ...
 - [Vue Native Scrollbar](http://serafin.io/vue-native-scrollbar/) - Vue 2 directive for custom scrollbar that uses native scroll behavior. Lightweight, performant, customizable and without dependencies.
