...
#### Vuex Utilities
 ...
 - [vuex-persist](http://championswimmer.in/vuex-persist/) - A Typescript-ready Vuex plugin to help save the store to localStorage or any custom Storage (that you can configure)
