...
- #### General Plugins/Directives
  ...
  - [vue-lazyload-img](https://github.com/JALBAA/vue-lazyload-img) lazyload images plugin for Vue, espacially optimized for mobile browser. By [@JALBAA](https://github.com/JALBAA)
- #### Talks
