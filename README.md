...
- [**GitHub Repo ★19,662**](https://github.com/vuejs/vue)
...
- [**Vue.js HackerNews Clone ★1,071**](https://github.com/vuejs/vue-hackernews)
...
- [**vue-cli ★809**](https://github.com/vuejs/vue-cli): official CLI for scaffolding Vue.js projects.
- [**vue-loader ★537**](https://github.com/vuejs/vue-loader) - Vue component loader for Webpack.
- [**vueify ★440**](https://github.com/vuejs/vueify) - Vue component transform for Browserify.
- [**vue-devtools ★724**](https://github.com/vuejs/vue-devtools) - Chrome devtools extension for debugging Vue applications.
...
- [vue-go-cli ★4](https://github.com/rodzzlessa24/vue-go-cli) - a CLI tool for scaffolding new projects generating components, services, and mixins.
- [brunch-vue ★5](https://github.com/nblackburn/vue-brunch) - Adds support to Brunch for pre-compiling single file Vue components.
- [vueify-extract-css ★21](https://github.com/rawcreative/vueify-extract-css) - Browserify plugin to extract css from Vueify-compiled single file components to a separate css file.
- [eslint-plugin-vue ★25](https://github.com/Twiknight/eslint-plugin-vue) - Eslint plugin for .vue files.
- [vbuild ★108](https://github.com/egoist/vbuild) - Preset build tool for Vue.js apps.

### Syntax Highlighting

- [**Sublime Text ★209**](https://github.com/vuejs/vue-syntax-highlight)
- [Atom](https://atom.io/packages/language-vue) by @hedefalk
- [Atom (2)](https://atom.io/packages/language-vue-component) by @CYBAI
- [Vim ★36](https://github.com/posva/vim-vue) by @darthmall and @posva
- [Visual Studio Code](https://marketplace.visualstudio.com/items/liuji-jim.vue) by Jim Liu
- [Brackets ★8](https://github.com/pandao/brackets-vue) by @pandao
- [**IntelliJ IDEA / WebStorm ★164**](https://github.com/henjue/vue-for-idea) by @henjue
- [Emacs ★7](https://github.com/CodeFalling/vue-mode) by @CodeFalling
...
- [**vue-mdl ★336**](https://github.com/posva/vue-mdl): Reusable Vue.js components using Material Design Lite. By [@posva](https://github.com/posva)
...
- [**vux ★1,531**](https://github.com/airyland/vux): Mobile web UI Components based on Vue and WeUI
...
- [vue-comps](https://github.com/vue-comps): A collection of unstyled and unanimated plain vue components
  - [vue-materialize ★45](https://github.com/paulpflug/vue-materialize): materializeCss styles and animations for `vue-comps`
  - [vue-clusterize ★21](https://github.com/vue-comps/vue-clusterize): implementation of clusterize.js in vue, invisible pagination
...
- #### Routing
  ...
  - [**vue-router ★1,308**](https://github.com/vuejs/vue-router) - Official router for building SPAs. <sup>1.0 compatible</sup>
  - [Vue page ★15](https://github.com/AlexToudic/vue-page), a routing system based on pagejs by @AlexToudic
  - [Vue Lanes ★20](https://github.com/bpierre/vue-lanes), an event-based routing system for Vue by @bpierre
  - [Vue route ★71](https://github.com/ayamflow/vue-route), ng-view inspired routes for Vue by @ayamflow
...
- #### Ajax/Data
  ...
  - [**vue-resource ★1,409**](https://github.com/vuejs/vue-resource) - AJAX/Resource plugin maintained by the [PageKit](http://pagekit.com/) team. <sup>1.0 compatible</sup>
  - [**vue-async-data ★202**](https://github.com/vuejs/vue-async-data) - Async data loading plugin <sup>1.0 compatible</sup>
  - [vue-async-computed ★16](https://github.com/foxbenjaminfox/vue-async-computed) - Plugin to support computed properties that are calculated asynchronously. By [@foxbenjaminfox](https://github.com/foxbenjaminfox)

- #### State Management

  - [**vuex ★1,555**](https://github.com/vuejs/vuex) - Flux/Redux inspired application architecture for Vue.js.
  - [**revue ★190**](https://github.com/revue/revue) - Redux binding for Vue by @egoist
  - [vue-redux ★80](https://github.com/yang-wei/vue-redux) - Redux binding for Vue by @yang-wei
  - [vue-freeze ★38](https://github.com/BosNaufal/vue-freeze) - Simple state management whitout bloating API and Concept for Vue by [@BosNaufal](https://github.com/BosNaufal)
  - [vue-simple-store ★30](https://github.com/BosNaufal/vue-simple-store) - Store Organizer To Simplify Your Stores for Vue By [@BosNaufal](https://github.com/BosNaufal)

- #### Validation

  - [**vue-validator ★631**](https://github.com/vuejs/vue-validator) - Form validation plugin maintained by @kazupon <sup>1.0 compatible</sup>
  - [Vue validator ★38](https://github.com/xrado/vue-validator) by @xrado
  - [**vue-form ★126**](https://github.com/fergaldoyle/vue-form) by @fergaldoyle <sup>1.0 compatible</sup>
...
- #### UI Components
  ...
  - [vue-countup ★9](https://github.com/samcrosoft/vue-countup): A Vue.js component for the very interesting [CountUp.js](https://inorganik.github.io/countUp.js/) plugin. <sup>1.0 compatible</sup>
  - [Vue Tag Editor Component ★22](https://github.com/hnakamur/vue.tag-editor.js) by @hnakamur
  ...
  - [vue-select ★54](https://github.com/Haixing-Hu/vue-select): A Vue.js component implementing the select control with the [jQuery select2 plugin](https://github.com/select2/select2).  By @Haixing-Hu
  - [vue-html-editor ★70](https://github.com/Haixing-Hu/vue-html-editor): A Vue.js component implementing the HTML editor with the [jQuery summernote plugin](https://github.com/summernote/summernote). By @Haixing-Hu
  - [vue-datetime-picker ★70](https://github.com/Haixing-Hu/vue-datetime-picker): A Vue.js component implementing the datetime picker control using the [Eonasdan's bootstrap datetime picker plugin](https://github.com/Eonasdan/bootstrap-datetimepicker). By @Haixing-Hu
  ...
  - [vue-panel ★39](https://github.com/ericmcdaniel/vue-panel): A suite of Vue.js components for building Flexbox layouts by @ericmcdaniel
  ...
  - [vue-transition ★38](https://github.com/Twiknight/vue-transition): A component to trigger a CSS transition at any time by @Twiknight
  ...
  - [Vue datepicker ★82](https://github.com/hilongjw/vue-datepicker): calendar and datepicker component with material design for Vue.js  by @hilongjw
  - [vue-date-picker ★25](https://github.com/Bubblings/vue-date-picker): A simple datepicker component for Vue.js by @Bubblings
  - [**vue-spinner ★184**](https://github.com/greyby/vue-spinner): A collection of loading spinners with Vue.js.
  - [vue-image-loader ★17](https://github.com/eduardostuart/vue-image-loader): Async image loader for Vue.js by @eduardostuart
  - [Vue-progressbar ★54](https://github.com/hilongjw/vue-progressbar): A lightweight progress bar for Vue.js  by @hilongjw
  - [Famous-Vue ★12](https://github.com/irwansyahwii/Famous-Vue): Declarative Famous using Vue
  - [**vue-waterfall ★249**](https://github.com/MopTym/vue-waterfall): A waterfall layout component for Vue.js by @MopTym
  - [vue-charts ★23](https://github.com/haydenbbickerton/vue-charts): A Google Charts plugin for Vue.js by [@haydenbbickerton](https://github.com/haydenbbickerton)
  - [**vue-select ★196**](https://github.com/sagalbot/vue-select): Simple component that implements Select2/Chosen style dropdowns with no dependencies<sup>1.0</sup>
  - [Vue-slide ★48](https://github.com/hilongjw/vue-slide): A lightweight slide component for Vue.js  by @hilongjw
  - [Vue-quill ★8](https://github.com/CroudSupport/vue-quill): A Vue component implementing the [Quill](https://github.com/quilljs/quill.git) text editor by @brockreece
  - [vue-pagenav ★8](https://github.com/zxdong262/vue-pagenav): A vue pagenav plugin by [@zxdong262](https://github.com/zxdong262)
  - [Vue-calendar ★3](https://github.com/cucygh/vue-calendar): A vue calendar component with less code by cucygh
  - [vue-autocomplete ★27](https://github.com/BosNaufal/vue-autocomplete) Autocomplete Component for Vue by [@BosNaufal](https://github.com/BosNaufal)
  - [vue-loading-bar ★37](https://github.com/BosNaufal/vue-loading-bar) Youtube Like Loading Bar Component for Vue by [@BosNaufal](https://github.com/BosNaufal)
  - [vue-bootstrap-modal ★14](https://github.com/Coffcer/vue-bootstrap-modal) Bootstrap style modal component for Vue by [@Coffcer](https://github.com/Coffcer)
  - [vue-waves ★5](https://github.com/Teddy-Zhu/vue-waves):Click effect inspired by Google's Material Design ,the vue version By @Teddy-Zhu
...
- #### i18n
  ...
  - [**vue-i18n ★204**](https://github.com/kazupon/vue-i18n): Internationalization plugin by @kazupon <sup>1.0, 2.0-pre-alpha compatible</sup>
  - [vue-localize](https://github.com/Saymon-biz/vue-localize): Internationalization plugin for vue.js based applications
  - [vue-i18n ★33](https://github.com/Haixing-Hu/vue-i18n): A plugin providing a global interface used to localize internationalized messages used in the
  - [vue-i18n ★12](https://github.com/jinzhe/vue-i18n): Internationalization plugin by @jinzhe<sup>1.x</sup>
  - [vue-locale ★10](https://github.com/sebastian-software/vue-locale): Advanced localization support for VueJS by @sebastiansoft
...
- #### Examples
  ...
  - [Node Webkit + Vue example ★36](https://github.com/brandonjpierce/node-webkit-boilerplate) by @brandonjpierce
  - [Vue Samples ★22](https://github.com/superlloyd/VueSamples) by @superlloyd
  - [HackerNews clone with vue.js + vue-router ★5](https://github.com/kazupon/vue-router-hackernews) by @kazupon
  - [**Electron + Vue example ★196**](https://github.com/bradstewart/electron-boilerplate-vue) by @bradstewart
  - [Single page application example (Vue + Voie)](https://github.com/inca/voie-example) by [Boris Okunskiy](https://github.com/inca)
  - [Begin - Task Manager SPA written in Vue + Lumen ★14](https://github.com/rajabishek/begin) by [Raj Abishek](https://github.com/rajabishek)
  - [Vue Mini Shop ★24](https://github.com/BosNaufal/vue-mini-shop) by [BosNaufal](https://github.com/BosNaufal)
  - [Vue SoundCloud ★13](https://github.com/mul14/vue-soundcloud) by [mul14](https://github.com/mul14)
  ...
  - [Vue Cookbook (Vue1.0 + express) ★102](https://github.com/yjj5855/node-vue-server-webpack) by [@yjj5855](https://github.com/yjj5855): A demo first screen rendering of a service
...
- #### Boilerplates
  - [Boilerplate for Vue.js plugin  ★20](https://github.com/kazupon/vue-plugin-boilerplate) by @kazupon
  - [Boilerplate for Vue.js & Atom Electron  ★46](https://github.com/rodzzlessa24/vue-electron) by @rodzzlessa24
  - [Boilerplate for single page applications](https://github.com/sebastian-software/modern-spa-boilerplate) by @sebastiansoft
  - [Boilerplate for SPAs use vuex & vue-router ★22j](https://github.com/crossjs/plato) by @crossjs

- #### Scaffolding

  - [**vue-cli ★809**](https://github.com/vuejs/vue-cli): official CLI for scaffolding Vue.js projects.
  - [Vue generator ★72](https://github.com/BirdEggegg/generator-vuejs): a simple yeoman generator for Vue by @BirdEggegg
  - [VENM stack yeoman generator ★37](https://github.com/jfelsinger/generator-venm) by @jfelsinger
  - [Grail Yeoman Generator ★10](https://github.com/mustardamus/generator-grail): a advanced yeoman generator for a modern modular one page web app, extendable with Vue.js alongside other nice tools
  - [**VuePack ★191**](https://github.com/egoist/vuepack): A modern starter for Vue and Webpack by @egoist
  - [VueWebgulp ★42](https://github.com/rodzzlessa24/vue-webgulp): A skeleton app using Vuejs, Gulp, and Webpack by @rodzzlessa24
  - [Vuetober ★24](https://github.com/scottbedard/oc-vuetober-theme): SPA scaffolding for October CMS
  - [vue-go-cli ★4](https://github.com/rodzzlessa24/vue-go-cli) - a CLI tool for scaffolding new projects generating components, services, and mixins.
  - [Brunch with Vue ★12](https://github.com/nblackburn/brunch-with-vue) - A skeleton application utilizing vue, vuex, vue-resource and vue-router.

- #### Integrations

  - [Vue for Meteor ★81](https://github.com/zhouzhuojie/meteor-vue) by @zhouzhuojie
  ...
  - [Vue-Meteor-Data ★16](https://github.com/Grottolabs/vue-meteor-data) Two-way-reactivity mixin for Vue and Meteor by @JakobRosenberg
...
- #### General Plugins/Directives
  ...
  - [**vue-touch ★283**](https://github.com/vuejs/vue-touch): Hammer.js wrapper directives for touch gestures. (Updated for 1.0!)
  - [vue-animated-list ★127](https://github.com/vuejs/vue-animated-list): A Vue.js plugin for easily animating `v-for` rendered lists.
  - [Vue placeholder directives ★48](https://github.com/lithiumjake/vue-placeholders) by @lithiumjake
  - [Vue in viewport detection directive ★28](https://github.com/holic/vue-viewport) by @holic
  ...
  - [Maintain scroll position on page changes ★18](https://github.com/mark-hahn/vue-keep-scroll) by @mark-hahn
  ...
  - [vue-clickaway ★41](https://github.com/simplesmiler/vue-clickaway): Assign a method to be called whenever user clicks away from the element. By @simplesmiler
  - [vue-focus ★31](https://github.com/simplesmiler/vue-focus): Manage input focus in the MVVM-friendly way. By @simplesmiler
  - [vue-transfer-dom ★21](https://github.com/rhyzx/vue-transfer-dom): Transfer DOM to another location. by @rhyzx
  - [vue-lazyload ★77](https://github.com/hilongjw/vue-lazyload): lazyloading images. by @hilongjw
  ...
  - [vue-mixins ★11](https://github.com/paulpflug/vue-mixins) A collection of mixins aimed to replace some jQuery functionality
  ...
  - [vue-paginate ★52](https://github.com/TahaSh/vue-paginate) A simple plugin to use pagination in vue.js. by @TahaSh
  - [vue-super ★6](https://github.com/rpkilby/vue-super) A simple plugin to call methods on parent components.
  - [vue-deepstream ★7](https://github.com/arexio/vue-deepstream) Plugin to simplify event subscription and event trigger when using [deepstream.io](https://deepstream.io/)
  ...
  - [vue-animate ★21](https://github.com/haydenbbickerton/vue-animate): Use [Animate.css](https://github.com/daneden/animate.css "Animate.css") with Vue.js transitions. By [@haydenbbickerton](https://github.com/haydenbbickerton)
  - [vue-sortable ★43](https://github.com/sagalbot/vue-sortable): A lightweight directive for reorderable drag-and-drop lists using [RubaXa/Sortable](https://github.com/RubaXa/Sortable). By [@sagalbot](https://github.com/sagalbot)
  - [vue-loading ★22](https://github.com/Coffcer/vue-loading): Vue directive, show loading block in any element. By [@coffcer](https://github.com/Coffcer)
  - [vue-gesture ★13](https://github.com/mlyknown/vue-gesture):touch events plugin for Vue.js.You can v-gesture directive,and directive auguments can use a tap, swipe, etc.
  - [vue-lazyload-img ★22](https://github.com/JALBAA/vue-lazyload-img) another image lazyload plugin for Vue, especially optimized for mobile browser. By [@JALBAA](https://github.com/JALBAA)
  ...
  - [vue-socket.io ★21](https://github.com/MetinSeylan/Vue-Socket.io) : [socket.io-client](http://socket.io) plugin for Vuejs, manage socket.io event in Vue vm. By [@MetinSeylan](https://github.com/MetinSeylan)
...
- #### Open Source
  ...
  - [Todolist ★14](https://github.com/Memkits/todolist) by @jiyinyiyong
  - [Dashboard framework ★44](https://github.com/thelinuxlich/vue-dashing-js) by @thelinuxlich
  - [a simple notepad ★46](https://github.com/sapjax/fewords)
  - [**FilterBlend ★137**](https://github.com/ilyashubin/FilterBlend): CSS blend modes and filters playground by @ilyashubin
  ...
  - [**RSS Reader ★161**](https://github.com/mrgodhani/rss-reader) Simple RSS Reader made using atom electron and vue.js.
  - [**Gokotta ★157**](https://github.com/Zhangdroid/Gokotta): A simple music player built by electron and vue.
  - [Coffeebreak ★52](https://github.com/Kocisov/coffeebreak) Tool for live editing CSS components
...
- #### Apps/Websites
  ...
  - [Reddit News ★29](https://github.com/Mati365/reddit-news) A browser extension which show notifications and news from reddit
