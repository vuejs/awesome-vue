...
*Scaffold parts of the app*
 ...
 - [vue-component-boilerplate](https://github.com/vue-templates/vue-component-boilerplate) - Template for generating the boilerplate code for a VueJS components, with build scripts and testing pre-installed.
