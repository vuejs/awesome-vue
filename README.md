...
- [MoonProxy](https://github.com/MoonProxyHQ/moonproxy-desktop) - FRP desktop GUI client for internal network penetration and remote access, built with Tauri v2, Vue 3, and Rust.
