...
- [Vue 3 Shopping Cart](https://github.com/sorxrob/vue-keep) - A Shopping cart example using Vue 3, Vite, [daisyUI](https://daisyui.com/) and [Pinia](https://pinia.esm.dev/).
