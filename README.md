...
- #### Integrations
  ...
  - [vuets](https://github.com/dyu/vuets): Vue components using typescript 2.0 with compatibility layer between version 1 and 2 of vue and vue-router. By [@dyu](https://github.com/dyu)
