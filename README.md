...
*A slim progress bar at the top of the page*
 ...
 - [vue-component-loading](https://github.com/val-bubbleflat/vue-component-loading) - Manage a loading state inside each component ans display the global loading state with a progressbar. 
