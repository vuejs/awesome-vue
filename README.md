...
*Manage meta information in the document head*
 ...
 - [vue-simple-headful](https://github.com/Raiondesu/vue-simple-headful) - Easily set meta-tags with vue.js - a simpler `vue-headful` alternative with TypeScript support.
