...
- [vue-pwa-speech](https://github.com/aofdev/vue-pwa-speech) - A Performs synchronous speech recognition Speech To Text With Google Cloud Speech on Progressive Web App
