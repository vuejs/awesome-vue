...
> Uma lista selecionada de coisas incríveis relacionadas ao Vue.js

- [Recursos](#resources)
  - [Recursos Oficiais](#official-resources)
  - [Recursos Externos](#external-resources)
  - [Portais de emprego](#job-portal)
  - [Comunidades](#community)
  - [Conferências](#conferences)
  - [Podcasts](#podcasts)
  - [Canais do Youtube](#youtube-channels)
  - [Exemplos Oficiais](#official-examples)
  - [Tutorias](#tutorials)
  - [Exemplos](#examples)
  - [Livros](#books)
  - [Blogs](#blog-posts)
...
- [Projectos usando Vue.js](#projects-using-vuejs)
  - [Open Source](#open-source)
  - [Productos Comerciais](#commercial-products)
  - [Apps/Websites](#appswebsites)
  - [Experiências Interativas](#interactive-experiences)
  - [Empresas Usando](#enterprise-usage)
  - [A11y](#a11y)
- [Componentes & Bibliotecas](#components--libraries)
  - [Componentes UI](#ui-components)
    ...
    - [Form](#form)
      ...
      - [Manipulação de Vídeo](#video-manipulation)
      - [File Upload](#file-upload)
      - [Context Menu](#context-menu)
      - [Diversos](#miscellaneous-1)
      - [Wizard](#wizard)
      - [CSV](#csv)
      - [Sistema de Comentário](#comment-system)
    - [Canvas](#canvas)
  ...
  - [Frameworks](#frameworks)
    ...
    - [Other](#other)
  - [Utilitários de UI](#ui-utilities)
  ...
  - [Utilitários](#utilities)
    ...
    - [Gerenciamento de Estado](#state-management)
      - [Redux](#redux)
      - [Mobx](#mobx)
      - [Autenticação/Autorização](#authenticationauthorization)
      - [Utilitários Vuex](#vuex-utilities)
  ...
  - [Dev Tools](#dev-tools)
    ...
    - [Editores de Código](#source-code-editing)
      - [Atom](#atom)
...
- [Referências API](http://vuejs.org/api/)
...
- [Vue.js 資料まとめ(para japoneses)](https://gist.github.com/hashrock/f575928d0e109ace9ad0) by @hashrock
- [Vue.js Newsletter](http://vue-newsletter.com/) - Dose semanal de notícias Vue.js escolhidas a dedo
- [Vue.js Wikipédia](https://en.wikipedia.org/wiki/Vue.js)
- [Vue.js Radar](https://www.vuejsradar.com) - Boletim informativo com curadoria + site cobrindo novos lançamentos / contribuições Vue.js.
- [Vue News](https://vuenews.io) - Rede social com foco nas últimas notícias e informações do Vue.js.
- [Vue Curated Resources](https://hackr.io/tutorials/learn-vue-js) - Cursos e tutoriais Vue.js recomendados.
- [Vue School](https://vueschool.io) - Aprenda Vue.js com cursos em vídeo ministrados por membros principais e especialistas do setor.
- [VueDose](https://vuedose.tips). Dicas e truques sobre o ecossistema Vue, para desenvolvedores ocupados.
- [Vuelibs](https://vuelibs.org). Uma lista minimalista de bibliotecas e componentes Vue.js com base no repositório awesome-vue.
- [Vue.js DEV Community](https://dev.to/t/vue) - Tag oficial para a estrutura JavaScript Vue.js em DEV.to
- [Vue.js Online Courses Directory](https://classpert.com/vuejs) - Cursos Vue.js das principais plataformas de e-learning com curadoria da Classpert, um mecanismo de busca de cursos online.
- [WebTechSurvey.com](https://webtechsurvey.com/technology/vue.js) - Uma extensa lista de sites criados com a framework Javascript Vue.js.
- [Vue Mastery](https://www.vuemastery.com/) - O melhor recurso de aprendizagem para desenvolvedores Vue.

### Portais de Emprego

- [Vue.js Jobs - VueJobs](https://vuejobs.com/) - Um portal de empregos Vue.js para contratar ou ser contratado para todos os seus empregos Vue.js.
- [Vue.js Interview Questions](https://github.com/sudheerj/vuejs-interview-questions) - Uma lista de 300 perguntas e respostas da entrevista VueJS.
- [Prokarman Resume Builder](https://prokarman.com/) - Um Construtor de currículos grátis para criar currículos para o emprego dos seus sonhos.

### Comunidades

- [Twitter](https://twitter.com/vuejs)
- [Forúm Oficial](http://forum.vuejs.org/)
- [vue-requests](https://github.com/vuejs/vue-requests) - Solicite um módulo Vue.js que você deseja que exista ou obtenha ideias para módulos.
- [VueJS Iran - Canal e grupo do Telegram (link do grupo esta na biografia do canal)](https://telegram.me/vue_js)
- [vueslack - 2300+ de usuários registrados em todo mundo](https://vueslack.slack.com/)
- [Vue Land - Servidor do Chat no Discord](https://vue-land.js.org/)
- [VueJS Rússia - Grupo do Telegram [Russo]](https://t.me/vuejs_ru)
- [VueJS Vietnã - Grupo do Facebook](https://www.facebook.com/groups/vuejsvietnam/)
- [VueJS Tailândia - Grupo do Facebook](https://www.facebook.com/groups/VuejsThailand/)
- [VueJS Brasil - Grupo do Telegram [Português]](https://t.me/vuejsbrasil)
- [VueJS Brasil - Página do Facebook [Português]](https://www.facebook.com/vuejsbrasil/)
- [VueJS Brasil - Grupo do Facebook [Português]](https://www.facebook.com/groups/vuejsbr/)
- [VueJS Angola - Grupo do Facebook [Português]](https://www.facebook.com/groups/371849227190800)
- [VueJS em Espanhol - Grupo do Facebook](https://www.facebook.com/groups/vue.es/)
- [VueJS Índia - Servidor do Chat no Discord](https://goo.gl/mYXKUv)
- [VueJS Indonésia - Grupo do Telegram[Indonês]](https://t.me/vuejsindonesia)
- [VueJS Indonésia - Grupo do Facebook[Indonês]](https://www.facebook.com/groups/1675298779418239/)
- [VueJS Indonésia - Página do Meetup [Indonês]](https://www.meetup.com/Vuejs-Indonesia/)
- [VueJS Hong Kong - Grupo do Facebook](https://www.facebook.com/groups/887185518120024)
- [VueJS Árabia - Grupo do Telegram](https://t.me/vuejsarab)
- [VueJS Vix - Grupo do Telegram [Português]](https://t.me/vuejsvix)
- [VueJS Vix - Página do Meetup [Português]](https://www.meetup.com/pt-BR/Vue-js-in-Vix/)
- [VueJS Noruega - Meetup](https://www.meetup.com/VueJS-Oslo/)
- [VueJS Israel 🇮🇱 - Página do Facebook](https://www.facebook.com/officalVuejsIsrael/)
- [VueJS Filândia - Meetup](https://www.meetup.com/vuejs-finland/)
- [VueJS Filândia - Página do Facebook](https://www.facebook.com/vuejsfinland/)
- [Hablemos de Vue.js - Grupo do Telegram [Casteliano]](https://t.me/vuejsEs)
- [VueBLR - Meetup](https://www.meetup.com/vue-bangalore/)
- [VueBLR - Grupo do WhatsApp](http://bit.ly/vueblr-whatsapp)
- [VueBLR - Grupo do Facebook](https://www.facebook.com/groups/vue.blr/)
- [VueJS USA - Meetups](https://events.vuejs.org/meetups/#united-states)
- [VueJS CZ/SK -Grupo do Discord](https://discord.gg/mDr2z8V)
- [VueJS DOM - Grupo do WhatsApp](https://chat.whatsapp.com/L5rFQpme22IHmmyOMI1MWA)
- [VueJS DOM - Grupo do Facebook](https://www.facebook.com/groups/2022974857757366/)
